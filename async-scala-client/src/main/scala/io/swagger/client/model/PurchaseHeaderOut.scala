...
entity: Option[PurchaseEntity],
payment: Option[PurchaseHeaderOut_payment],
taxesConfig: Option[PurchaseTaxesConfig],
defaultLocations: Option[PurchaseDefaultLocations]
)
