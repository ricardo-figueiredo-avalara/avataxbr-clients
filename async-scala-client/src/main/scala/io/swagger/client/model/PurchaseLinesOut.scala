...
lineNetValue: Option[Double],  // This decimal captures the value of lineAmount - lineTaxedDiscount - sum of withholding.
calculatedTax: Option[PurchaseCalculatedTax]
)
