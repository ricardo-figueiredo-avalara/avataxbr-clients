...
taxBaseDiscount: Option[Double],  // ICMS Tax base rate discount  (desconto na base do ICMS referetne a desoneração)
taxAmount: Option[Double]  // Amount for Icms Relief (desoneração)
)
