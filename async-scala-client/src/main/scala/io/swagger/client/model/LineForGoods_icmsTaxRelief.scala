...
case class LineForGoods_icmsTaxRelief (
...
icmsReliefTaxRate: Option[Double],  // ICMS Tax base rate discount  (desconto na base do ICMS referetne a desoneração)
icmsReliefTaxAmount: Option[Double]  // Amount for Icms Relief (desoneração)
)
