...
class InlineResponse2004(object):
    ...
    def environment(self):
        """
        Gets the environment of this InlineResponse2004.
        - '1' # Ambiente de Produção - '2' # Ambiente de Homologação                 

        :return: The environment of this InlineResponse2004.
        :rtype: str
        """
    ...
    def environment(self, environment):
        """
        Sets the environment of this InlineResponse2004.
        - '1' # Ambiente de Produção - '2' # Ambiente de Homologação                 

        :param environment: The environment of this InlineResponse2004.
        :type: str
        """
        allowed_values = ["1", "2"]
