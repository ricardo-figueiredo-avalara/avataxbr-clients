...
class TaxConf(object):
    ...
    def code(self):
        """
        Gets the code of this TaxConf.
        main unique identificator

        :return: The code of this TaxConf.
        :rtype: str
        """
        return self._code
    ...
    def code(self, code):
        """
        Sets the code of this TaxConf.
        main unique identificator

        :param code: The code of this TaxConf.
        :type: str
        """
        if code is None:
    ...
    def stock_impact(self):
        """
        Gets the stock_impact of this TaxConf.
        Inform that the process has inventory impact.

        :return: The stock_impact of this TaxConf.
        :rtype: bool
        """
    ...
    def stock_impact(self, stock_impact):
        """
        Sets the stock_impact of this TaxConf.
        Inform that the process has inventory impact.

        :param stock_impact: The stock_impact of this TaxConf.
        :type: bool
        """
    ...
    def financial_impact(self):
        """
        Gets the financial_impact of this TaxConf.
        Inform that the process has financial impact.

        :return: The financial_impact of this TaxConf.
        :rtype: bool
        """
    ...
    def financial_impact(self, financial_impact):
        """
        Sets the financial_impact of this TaxConf.
        Inform that the process has financial impact.

        :param financial_impact: The financial_impact of this TaxConf.
        :type: bool
        """
    ...
    def cst_ipi(self):
        """
        Gets the cst_ipi of this TaxConf.
        ...
        :return: The cst_ipi of this TaxConf.
        :rtype: str
        """
    ...
    def cst_ipi(self, cst_ipi):
        """
        Sets the cst_ipi of this TaxConf.
        Inform if this process is subject to IPI taxation on output process - 'T'  # TAXABLE - 'Z'  # TAXABLE WITH RATE=0.00 - 'E'  # EXEMPT - 'H'  # SUSPENDED - 'N'  # NO TAXABLE     - 'I'  # IMMUNE - 'O'  # OTHER - 'OZ' # OTHER AND ZERO VALUES 

        :param cst_ipi: The cst_ipi of this TaxConf.
        :type: str
        """
    ...
    def ipi_legal_tax_class(self):
        """
        Gets the ipi_legal_tax_class of this TaxConf.
        ...
        :return: The ipi_legal_tax_class of this TaxConf.
        :rtype: str
        """
    ...
    def ipi_legal_tax_class(self, ipi_legal_tax_class):
        """
        Sets the ipi_legal_tax_class of this TaxConf.
        Legal tax classificação for IPI (enquadramento) When the processo has CST IPI 52 or 54, is mandatory inform Reason Code, see Anexo XIV - Código de Enquadramento Legal do IPI from  http://www.nfe.fazenda.gov.br/portal/exibirArquivo.aspx?conteudo=mCnJajU4BKU= 

        :param ipi_legal_tax_class: The ipi_legal_tax_class of this TaxConf.
        :type: str
        """
    ...
    def accruable_pis_taxation(self):
        """
        Gets the accruable_pis_taxation of this TaxConf.
        ...
        :return: The accruable_pis_taxation of this TaxConf.
        :rtype: str
        """
    ...
    def accruable_pis_taxation(self, accruable_pis_taxation):
        """
        Sets the accruable_pis_taxation of this TaxConf.
        Inform if this item by nature is subject to PIS taxation or exempt - 'T' # TAXABLE - 'Z' # TAXABLE WITH RATE=0.00 - 'E' # EXEMPT - 'H' # SUSPENDED - 'N' # NO TAXABLE - 'O' # OTHER - 'OZ'# OTHER AND ZERO VALUES 

        :param accruable_pis_taxation: The accruable_pis_taxation of this TaxConf.
        :type: str
        """
    ...
    def pis_exempt_legal_reason_code(self):
        """
        Gets the pis_exempt_legal_reason_code of this TaxConf.
        When exempt, taxable with zero, suspended, not taxable, this field holds the official code number

        :return: The pis_exempt_legal_reason_code of this TaxConf.
        :rtype: str
        """
    ...
    def pis_exempt_legal_reason_code(self, pis_exempt_legal_reason_code):
        """
        Sets the pis_exempt_legal_reason_code of this TaxConf.
        When exempt, taxable with zero, suspended, not taxable, this field holds the official code number

        :param pis_exempt_legal_reason_code: The pis_exempt_legal_reason_code of this TaxConf.
        :type: str
        """
    ...
    def pis_exempt_legal_reason(self):
        """
        Gets the pis_exempt_legal_reason of this TaxConf.
        When specifi reason, this field has the description

        :return: The pis_exempt_legal_reason of this TaxConf.
        :rtype: str
        """
    ...
    def pis_exempt_legal_reason(self, pis_exempt_legal_reason):
        """
        Sets the pis_exempt_legal_reason of this TaxConf.
        When specifi reason, this field has the description

        :param pis_exempt_legal_reason: The pis_exempt_legal_reason of this TaxConf.
        :type: str
        """
    ...
    def accruable_cofins_taxation(self):
        """
        Gets the accruable_cofins_taxation of this TaxConf.
        ...
        :return: The accruable_cofins_taxation of this TaxConf.
        :rtype: str
        """
    ...
    def accruable_cofins_taxation(self, accruable_cofins_taxation):
        """
        Sets the accruable_cofins_taxation of this TaxConf.
        Inform if this item by nature is subject to COFINS taxation or exempt - 'T'  # TAXABLE - 'Z'  # TAXABLE WITH RATE=0.00 - 'E'  # EXEMPT - 'H'  # SUSPENDED - 'N'  # NO TAXABLE     - 'O'  # OTHER - 'OZ' # OTHER AND ZERO VALUES 

        :param accruable_cofins_taxation: The accruable_cofins_taxation of this TaxConf.
        :type: str
        """
        allowed_values = ["T", "Z", "E", "H", "N", "O", "OZ"]
    ...
    def cofins_exempt_legal_reason_code(self):
        """
        Gets the cofins_exempt_legal_reason_code of this TaxConf.
        When exempt, taxable with zero, suspended, not taxable, this field holds the official code number

        :return: The cofins_exempt_legal_reason_code of this TaxConf.
        :rtype: str
        """
    ...
    def cofins_exempt_legal_reason_code(self, cofins_exempt_legal_reason_code):
        """
        Sets the cofins_exempt_legal_reason_code of this TaxConf.
        When exempt, taxable with zero, suspended, not taxable, this field holds the official code number

        :param cofins_exempt_legal_reason_code: The cofins_exempt_legal_reason_code of this TaxConf.
        :type: str
        """
    ...
    def cofins_exempt_legal_reason(self):
        """
        Gets the cofins_exempt_legal_reason of this TaxConf.
        When specifi reason, this field has the description

        :return: The cofins_exempt_legal_reason of this TaxConf.
        :rtype: str
        """
    ...
    def cofins_exempt_legal_reason(self, cofins_exempt_legal_reason):
        """
        Sets the cofins_exempt_legal_reason of this TaxConf.
        When specifi reason, this field has the description

        :param cofins_exempt_legal_reason: The cofins_exempt_legal_reason of this TaxConf.
        :type: str
        """
    ...
    def allow_ip_icredit_when_in_going(self):
        """
        Gets the allow_ip_icredit_when_in_going of this TaxConf.
        Inform that the process allow IPI credit to Input process

        :return: The allow_ip_icredit_when_in_going of this TaxConf.
        :rtype: bool
        """
    ...
    def allow_ip_icredit_when_in_going(self, allow_ip_icredit_when_in_going):
        """
        Sets the allow_ip_icredit_when_in_going of this TaxConf.
        Inform that the process allow IPI credit to Input process

        :param allow_ip_icredit_when_in_going: The allow_ip_icredit_when_in_going of this TaxConf.
        :type: bool
        """
    ...
    def icms_conf(self):
        """
        Gets the icms_conf of this TaxConf.
        the map key is state code

        :return: The icms_conf of this TaxConf.
    ...
    def icms_conf(self, icms_conf):
        """
        Sets the icms_conf of this TaxConf.
        the map key is state code

        :param icms_conf: The icms_conf of this TaxConf.
