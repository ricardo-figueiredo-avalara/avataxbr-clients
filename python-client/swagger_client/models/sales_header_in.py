...
class SalesHeaderIn(object):
    """
    NOTE: This class is auto generated by the swagger code generator program.
    Do not edit the class manually.
    """
    def __init__(self, account_id=None, company_code=None, transaction_type=None, document_code=None, currency=None, transaction_date=None, tax_calculation_date=None, company_location=None, customer_code=None, purchase_order_number=None, rps_number=None, rps_serie='0', discrimination_in=None, entity=None, payment=None, taxes_config=None, default_locations=None):
        """
        SalesHeaderIn - a model defined in Swagger
    ...
    def account_id(self):
        """
        Gets the account_id of this SalesHeaderIn.
        ...
        :return: The account_id of this SalesHeaderIn.
        :rtype: str
        """
    ...
    def account_id(self, account_id):
        """
        Sets the account_id of this SalesHeaderIn.
        This string is a UUID issued by Avalara to identify the Avalara account that owns the company identified by the companyCode on the next line.

        :param account_id: The account_id of this SalesHeaderIn.
        :type: str
        """
    ...
    def company_code(self):
        """
        Gets the company_code of this SalesHeaderIn.
        ...
        :return: The company_code of this SalesHeaderIn.
        :rtype: str
        """
    ...
    def company_code(self, company_code):
        """
        Sets the company_code of this SalesHeaderIn.
        This string is a code maintained by the client application to uniquely identify the company for which this transaction is being recorded. It is unique within the context of an Account. It will be limited to 60 characters when creating a Company

        :param company_code: The company_code of this SalesHeaderIn.
        :type: str
        """
    ...
    def transaction_type(self, transaction_type):
        """
        Sets the transaction_type of this SalesHeaderIn.
        This string indicates the type of transaction for which tax should be calculated. - 'Sale' - 'Purchase' - 'Payment' - 'Receipt' 

        :param transaction_type: The transaction_type of this SalesHeaderIn.
        :type: str
        """
    ...
    def document_code(self):
        """
        Gets the document_code of this SalesHeaderIn.
        This string is a code maintained by the client application to uniquely identify a document in the client's systems. It will typically be an invoice number, sales order, receipt number, returned merchandise authorization number, etc. When has this field, the transaction will be stored

        :return: The document_code of this SalesHeaderIn.
        :rtype: str
        """
    ...
    def document_code(self, document_code):
        """
        Sets the document_code of this SalesHeaderIn.
        This string is a code maintained by the client application to uniquely identify a document in the client's systems. It will typically be an invoice number, sales order, receipt number, returned merchandise authorization number, etc. When has this field, the transaction will be stored

        :param document_code: The document_code of this SalesHeaderIn.
        :type: str
        """
    ...
    def currency(self):
        """
        Gets the currency of this SalesHeaderIn.
        currency code / transactions must be in Brazilian Reais \"BRL\"

        :return: The currency of this SalesHeaderIn.
        :rtype: str
        """
    ...
    def currency(self, currency):
        """
        Sets the currency of this SalesHeaderIn.
        currency code / transactions must be in Brazilian Reais \"BRL\"

        :param currency: The currency of this SalesHeaderIn.
        :type: str
        """
        allowed_values = ["BRL"]
    ...
    def transaction_date(self):
        """
        Gets the transaction_date of this SalesHeaderIn.
        ...
        :return: The transaction_date of this SalesHeaderIn.
        :rtype: date
        """
    ...
    def transaction_date(self, transaction_date):
        """
        Sets the transaction_date of this SalesHeaderIn.
        This string is the transaction date in ISO 8601 format (which may be different from the date the tax calculation is performed)

        :param transaction_date: The transaction_date of this SalesHeaderIn.
        :type: date
        """
    ...
    def tax_calculation_date(self):
        """
        Gets the tax_calculation_date of this SalesHeaderIn.
        ...
        :return: The tax_calculation_date of this SalesHeaderIn.
        :rtype: date
        """
    ...
    def tax_calculation_date(self, tax_calculation_date):
        """
        Sets the tax_calculation_date of this SalesHeaderIn.
        accrual date, This string is the date, in ISO 8601 format, on which tax is to be calculated for this transaction (normally tax is calculated on the date the transaction is performed as captured in the transactionDate field). This is useful for layaways and other deferred transactions.

        :param tax_calculation_date: The tax_calculation_date of this SalesHeaderIn.
        :type: date
        """
    ...
    def company_location(self):
        """
        Gets the company_location of this SalesHeaderIn.
        This string contains a previously configured company code which may also have codes needed for tax return purposes. These codes are maintained through the customer portal. Main company address identity

        :return: The company_location of this SalesHeaderIn.
        :rtype: str
        """
    ...
    def company_location(self, company_location):
        """
        Sets the company_location of this SalesHeaderIn.
        This string contains a previously configured company code which may also have codes needed for tax return purposes. These codes are maintained through the customer portal. Main company address identity

        :param company_location: The company_location of this SalesHeaderIn.
        :type: str
        """
    ...
    def customer_code(self):
        """
        Gets the customer_code of this SalesHeaderIn.
        ...
        :return: The customer_code of this SalesHeaderIn.
        :rtype: str
        """
    ...
    def customer_code(self, customer_code):
        """
        Sets the customer_code of this SalesHeaderIn.
        This string is a code maintained by the client application and recorded in Customer Portal to uniquely identify the party with whom the company (identified by companyCode) is transacting. It is unique within the context of a Company.

        :param customer_code: The customer_code of this SalesHeaderIn.
        :type: str
        """
    ...
    def purchase_order_number(self):
        """
        Gets the purchase_order_number of this SalesHeaderIn.
        The number of Purchase Order

        :return: The purchase_order_number of this SalesHeaderIn.
        :rtype: str
        """
    ...
    def purchase_order_number(self, purchase_order_number):
        """
        Sets the purchase_order_number of this SalesHeaderIn.
        The number of Purchase Order

        :param purchase_order_number: The purchase_order_number of this SalesHeaderIn.
        :type: str
        """
    ...
    def rps_number(self, rps_number):
        """
        Sets the rps_number of this SalesHeaderIn.
        Provisional receipt services, sequencial number maintained by the client application, unique by serie

        :param rps_number: The rps_number of this SalesHeaderIn.
        :type: int
        """
    ...
    def rps_serie(self):
        """
        Gets the rps_serie of this SalesHeaderIn.
        set name identifier for rps number sequency.

        :return: The rps_serie of this SalesHeaderIn.
        :rtype: str
        """
    ...
    def rps_serie(self, rps_serie):
        """
        Sets the rps_serie of this SalesHeaderIn.
        set name identifier for rps number sequency.

        :param rps_serie: The rps_serie of this SalesHeaderIn.
        :type: str
        """
    ...
    def discrimination_in(self):
        """
        Gets the discrimination_in of this SalesHeaderIn.
        Service discrimination, free description about service

        :return: The discrimination_in of this SalesHeaderIn.
        :rtype: str
        """
    ...
    def discrimination_in(self, discrimination_in):
        """
        Sets the discrimination_in of this SalesHeaderIn.
        Service discrimination, free description about service

        :param discrimination_in: The discrimination_in of this SalesHeaderIn.
        :type: str
        """
    ...
    def entity(self):
        """
        Gets the entity of this SalesHeaderIn.

        :return: The entity of this SalesHeaderIn.
        :rtype: SalesEntity
        """
        return self._entity
    ...
    def entity(self, entity):
        """
        Sets the entity of this SalesHeaderIn.

        :param entity: The entity of this SalesHeaderIn.
        :type: SalesEntity
        """
    ...
    def payment(self):
        """
        Gets the payment of this SalesHeaderIn.

        :return: The payment of this SalesHeaderIn.
        :rtype: SalesHeaderInPayment
        """
    ...
    def payment(self, payment):
        """
        Sets the payment of this SalesHeaderIn.

        :param payment: The payment of this SalesHeaderIn.
        :type: SalesHeaderInPayment
        """
    ...
    def taxes_config(self):
        """
        Gets the taxes_config of this SalesHeaderIn.

        :return: The taxes_config of this SalesHeaderIn.
    ...
    def taxes_config(self, taxes_config):
        """
        Sets the taxes_config of this SalesHeaderIn.

        :param taxes_config: The taxes_config of this SalesHeaderIn.
    ...
    def default_locations(self):
        """
        Gets the default_locations of this SalesHeaderIn.

        :return: The default_locations of this SalesHeaderIn.
    ...
    def default_locations(self, default_locations):
        """
        Sets the default_locations of this SalesHeaderIn.

        :param default_locations: The default_locations of this SalesHeaderIn.
