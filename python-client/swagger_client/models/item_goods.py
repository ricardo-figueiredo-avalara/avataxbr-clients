...
class ItemGoods(object):
    ...
    def cest(self, cest):
        """
        Sets the cest of this ItemGoods.
        tax substitution code - Codigo especificador da Substuicao Tributaria

        :param cest: The cest of this ItemGoods.
        :type: str
        """
