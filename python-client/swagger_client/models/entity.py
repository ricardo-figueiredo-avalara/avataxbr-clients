...
class Entity(object):
    ...
    """
    def __init__(self, name=None, role=None, type=None, federal_tax_id=None, city_tax_id=None, state_tax_id=None, suframa=None, phone=None, tax_regime=None, email=None, subject_to_srf1234=None):
        """
    ...
    def federal_tax_id(self):
        """
        Gets the federal_tax_id of this Entity.
        CNPJ/CPF of Sales Buyer, if CPF pattern is '[0-9]{11}' if CNPJ pattern is '[0-9]{14}'

        :return: The federal_tax_id of this Entity.
        :rtype: str
        """
    ...
    def federal_tax_id(self, federal_tax_id):
        """
        Sets the federal_tax_id of this Entity.
        CNPJ/CPF of Sales Buyer, if CPF pattern is '[0-9]{11}' if CNPJ pattern is '[0-9]{14}'

        :param federal_tax_id: The federal_tax_id of this Entity.
        :type: str
        """
    ...
    def city_tax_id(self):
        """
        Gets the city_tax_id of this Entity.
        City Tax ID

        :return: The city_tax_id of this Entity.
        :rtype: str
        """
    ...
    def city_tax_id(self, city_tax_id):
        """
        Sets the city_tax_id of this Entity.
        City Tax ID

        :param city_tax_id: The city_tax_id of this Entity.
        :type: str
        """
    ...
    def state_tax_id(self):
        """
        Gets the state_tax_id of this Entity.
        State Tax ID

        :return: The state_tax_id of this Entity.
        :rtype: str
        """
    ...
    def state_tax_id(self, state_tax_id):
        """
        Sets the state_tax_id of this Entity.
        State Tax ID

        :param state_tax_id: The state_tax_id of this Entity.
        :type: str
        """
    ...
    def suframa(self):
        """
        Gets the suframa of this Entity.
        Suframa ID

        :return: The suframa of this Entity.
        :rtype: str
        """
    ...
    def suframa(self, suframa):
        """
        Sets the suframa of this Entity.
        Suframa ID

        :param suframa: The suframa of this Entity.
        :type: str
        """
    ...
    def phone(self):
        """
        Gets the phone of this Entity.
        Entity Phone

        :return: The phone of this Entity.
        :rtype: str
        """
        return self._phone
    ...
    def phone(self, phone):
        """
        Sets the phone of this Entity.
        Entity Phone

        :param phone: The phone of this Entity.
        :type: str
        """
    ...
    def tax_regime(self):
        """
        Gets the tax_regime of this Entity.

        :return: The tax_regime of this Entity.
        :rtype: str
        """
    ...
    def tax_regime(self, tax_regime):
        """
        Sets the tax_regime of this Entity.

        :param tax_regime: The tax_regime of this Entity.
        :type: str
        """
    ...
    def email(self):
        """
        Gets the email of this Entity.
        Entity Email

        :return: The email of this Entity.
        :rtype: str
        """
        return self._email
    ...
    def email(self, email):
        """
        Sets the email of this Entity.
        Entity Email

        :param email: The email of this Entity.
        :type: str
        """
    ...
    def subject_to_srf1234(self, subject_to_srf1234):
        """
        Sets the subject_to_srf1234 of this Entity.
        Companies subject to follow same rules of Government entities (Instrução Normativa: SRF1234)

        :param subject_to_srf1234: The subject_to_srf1234 of this Entity.
        :type: bool
        """
