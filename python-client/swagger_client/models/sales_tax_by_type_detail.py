...
class SalesTaxByTypeDetail(object):
    """
    ...
    def __init__(self, location_type=None, jurisdiction_name=None, jurisdiction_type=None, tax_type=None, rate_type=None, scenario=None, subtotal_taxable=None, subtotal_exempt=None, rate=None, tax=None, exemption_code=None, significant_locations=None, tax_rule_type=None):
        """
        SalesTaxByTypeDetail - a model defined in Swagger
    ...
    def location_type(self):
        """
        Gets the location_type of this SalesTaxByTypeDetail.
        This string captures the applicable location type. Location used for calc. Buyer or Seller

        :return: The location_type of this SalesTaxByTypeDetail.
        :rtype: str
        """
    ...
    def location_type(self, location_type):
        """
        Sets the location_type of this SalesTaxByTypeDetail.
        This string captures the applicable location type. Location used for calc. Buyer or Seller

        :param location_type: The location_type of this SalesTaxByTypeDetail.
        :type: str
        """
    ...
    def jurisdiction_name(self):
        """
        Gets the jurisdiction_name of this SalesTaxByTypeDetail.
        Jurisdiction used for calctax amount

        :return: The jurisdiction_name of this SalesTaxByTypeDetail.
        :rtype: str
        """
    ...
    def jurisdiction_name(self, jurisdiction_name):
        """
        Sets the jurisdiction_name of this SalesTaxByTypeDetail.
        Jurisdiction used for calctax amount

        :param jurisdiction_name: The jurisdiction_name of this SalesTaxByTypeDetail.
        :type: str
        """
    ...
    def jurisdiction_type(self):
        """
        Gets the jurisdiction_type of this SalesTaxByTypeDetail.
        Type of jurisdiction - 'City' - 'State' - 'Country' 

        :return: The jurisdiction_type of this SalesTaxByTypeDetail.
        :rtype: str
        """
    ...
    def jurisdiction_type(self, jurisdiction_type):
        """
        Sets the jurisdiction_type of this SalesTaxByTypeDetail.
        Type of jurisdiction - 'City' - 'State' - 'Country' 

        :param jurisdiction_type: The jurisdiction_type of this SalesTaxByTypeDetail.
        :type: str
        """
    ...
    def tax_type(self, tax_type):
        """
        Sets the tax_type of this SalesTaxByTypeDetail.
        Tax identificator - 'aproxtribCity' - 'aproxtribFed' - 'pis' - 'pisRf' - 'cofins' - 'cofinsRf' - 'csll' - 'csllRf' - 'irrf' - 'inss' - 'inssRf' - 'iss' - 'issRf' - 'irpj' 

        :param tax_type: The tax_type of this SalesTaxByTypeDetail.
        :type: str
        """
        allowed_values = ["aproxtribCity", "aproxtribFed", "pis", "pisRf", "cofins", "cofinsRf", "csll", "csllRf", "irrf", "inss", "inssRf", "iss", "issRf", "irpj"]
    ...
    def rate_type(self):
        """
        Gets the rate_type of this SalesTaxByTypeDetail.
        Name of configuration rate

        :return: The rate_type of this SalesTaxByTypeDetail.
        :rtype: str
        """
    ...
    def rate_type(self, rate_type):
        """
        Sets the rate_type of this SalesTaxByTypeDetail.
        Name of configuration rate

        :param rate_type: The rate_type of this SalesTaxByTypeDetail.
        :type: str
        """
    ...
    def scenario(self):
        """
        Gets the scenario of this SalesTaxByTypeDetail.
        ...
        :return: The scenario of this SalesTaxByTypeDetail.
        :rtype: str
        """
    ...
    def scenario(self, scenario):
        """
        Sets the scenario of this SalesTaxByTypeDetail.
        This string captures the transaction scenario used to calculate the tax for this tax type. Scenarios are specific to the tax type. This field provides information about how the tax engine interpreted the transaction information that was passed in.

        :param scenario: The scenario of this SalesTaxByTypeDetail.
        :type: str
        """
    ...
    def subtotal_taxable(self):
        """
        Gets the subtotal_taxable of this SalesTaxByTypeDetail.
        This decimal captures how much of the lineAmount was taxable by this tax, calc base

        :return: The subtotal_taxable of this SalesTaxByTypeDetail.
        :rtype: float
        """
    ...
    def subtotal_taxable(self, subtotal_taxable):
        """
        Sets the subtotal_taxable of this SalesTaxByTypeDetail.
        This decimal captures how much of the lineAmount was taxable by this tax, calc base

        :param subtotal_taxable: The subtotal_taxable of this SalesTaxByTypeDetail.
        :type: float
        """
    ...
    def subtotal_exempt(self, subtotal_exempt):
        """
        Sets the subtotal_exempt of this SalesTaxByTypeDetail.
        This decimal captures how much of the lineAmount was non-taxed. This is simply the line amount minus the taxable.

        :param subtotal_exempt: The subtotal_exempt of this SalesTaxByTypeDetail.
        :type: float
        """
    ...
    def rate(self):
        """
        Gets the rate of this SalesTaxByTypeDetail.
        This decimal captures the tax rate for this tax.3.00 (3%)

        :return: The rate of this SalesTaxByTypeDetail.
        :rtype: float
        """
        return self._rate
    ...
    def rate(self, rate):
        """
        Sets the rate of this SalesTaxByTypeDetail.
        This decimal captures the tax rate for this tax.3.00 (3%)

        :param rate: The rate of this SalesTaxByTypeDetail.
        :type: float
        """
    ...
    def tax(self):
        """
        Gets the tax of this SalesTaxByTypeDetail.
        This decimal captures how much of the lineAmount was taxable by this tax

        :return: The tax of this SalesTaxByTypeDetail.
        :rtype: float
        """
        return self._tax
    ...
    def tax(self, tax):
        """
        Sets the tax of this SalesTaxByTypeDetail.
        This decimal captures how much of the lineAmount was taxable by this tax

        :param tax: The tax of this SalesTaxByTypeDetail.
        :type: float
        """
    ...
    def exemption_code(self):
        """
        Gets the exemption_code of this SalesTaxByTypeDetail.
        This string is required if is exempt

        :return: The exemption_code of this SalesTaxByTypeDetail.
        :rtype: str
        """
    ...
    def exemption_code(self, exemption_code):
        """
        Sets the exemption_code of this SalesTaxByTypeDetail.
        This string is required if is exempt

        :param exemption_code: The exemption_code of this SalesTaxByTypeDetail.
        :type: str
        """
    ...
    def significant_locations(self):
        """
        Gets the significant_locations of this SalesTaxByTypeDetail.
        ...
        :return: The significant_locations of this SalesTaxByTypeDetail.
        :rtype: list[str]
        """
    ...
    def significant_locations(self, significant_locations):
        """
        Sets the significant_locations of this SalesTaxByTypeDetail.
        This element captures the list of locations that contributed to the tax determination. for BR16 Service is Buyer and Seller Address

        :param significant_locations: The significant_locations of this SalesTaxByTypeDetail.
        :type: list[str]
        """
    ...
    def tax_rule_type(self):
        """
        Gets the tax_rule_type of this SalesTaxByTypeDetail.
        This string with type of rule - 'SELLER' - 'BUYER' - 'TRANSACTION' - 'ITEM' - 'TAX' 

        :return: The tax_rule_type of this SalesTaxByTypeDetail.
        :rtype: str
        """
    ...
    def tax_rule_type(self, tax_rule_type):
        """
        Sets the tax_rule_type of this SalesTaxByTypeDetail.
        This string with type of rule - 'SELLER' - 'BUYER' - 'TRANSACTION' - 'ITEM' - 'TAX' 

        :param tax_rule_type: The tax_rule_type of this SalesTaxByTypeDetail.
        :type: str
        """
