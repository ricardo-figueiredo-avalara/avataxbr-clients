...
void PurchaseTaxByTypeDetail::validate()
{
    // TODO: implement validation
}

web::json::value PurchaseTaxByTypeDetail::toJson() const
{
...
void PurchaseTaxByTypeDetail::fromJson(web::json::value& val)
{
...
void PurchaseTaxByTypeDetail::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void PurchaseTaxByTypeDetail::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
utility::string_t PurchaseTaxByTypeDetail::getLocationType() const
{
    return m_LocationType;
}
void PurchaseTaxByTypeDetail::setLocationType(utility::string_t value)
{
    m_LocationType = value;
    m_LocationTypeIsSet = true;
}
bool PurchaseTaxByTypeDetail::locationTypeIsSet() const
{
    return m_LocationTypeIsSet;
}
void PurchaseTaxByTypeDetail::unsetLocationType()
{
    m_LocationTypeIsSet = false;
}
utility::string_t PurchaseTaxByTypeDetail::getJurisdictionName() const
{
    return m_JurisdictionName;
}
void PurchaseTaxByTypeDetail::setJurisdictionName(utility::string_t value)
{
    m_JurisdictionName = value;
    m_JurisdictionNameIsSet = true;
}
bool PurchaseTaxByTypeDetail::jurisdictionNameIsSet() const
{
    return m_JurisdictionNameIsSet;
}
void PurchaseTaxByTypeDetail::unsetJurisdictionName()
{
    m_JurisdictionNameIsSet = false;
}
utility::string_t PurchaseTaxByTypeDetail::getJurisdictionType() const
{
    return m_JurisdictionType;
}
void PurchaseTaxByTypeDetail::setJurisdictionType(utility::string_t value)
{
    m_JurisdictionType = value;
    m_JurisdictionTypeIsSet = true;
}
bool PurchaseTaxByTypeDetail::jurisdictionTypeIsSet() const
{
    return m_JurisdictionTypeIsSet;
}
void PurchaseTaxByTypeDetail::unsetJurisdictionType()
{
    m_JurisdictionTypeIsSet = false;
}
utility::string_t PurchaseTaxByTypeDetail::getTaxType() const
{
    return m_TaxType;
}
void PurchaseTaxByTypeDetail::setTaxType(utility::string_t value)
{
    m_TaxType = value;
    m_TaxTypeIsSet = true;
}
bool PurchaseTaxByTypeDetail::taxTypeIsSet() const
{
    return m_TaxTypeIsSet;
}
void PurchaseTaxByTypeDetail::unsetTaxType()
{
    m_TaxTypeIsSet = false;
}
utility::string_t PurchaseTaxByTypeDetail::getRateType() const
{
    return m_RateType;
}
void PurchaseTaxByTypeDetail::setRateType(utility::string_t value)
{
    m_RateType = value;
    m_RateTypeIsSet = true;
}
bool PurchaseTaxByTypeDetail::rateTypeIsSet() const
{
    return m_RateTypeIsSet;
}
void PurchaseTaxByTypeDetail::unsetRateType()
{
    m_RateTypeIsSet = false;
}
utility::string_t PurchaseTaxByTypeDetail::getScenario() const
{
    return m_Scenario;
}
void PurchaseTaxByTypeDetail::setScenario(utility::string_t value)
{
    m_Scenario = value;
    m_ScenarioIsSet = true;
}
bool PurchaseTaxByTypeDetail::scenarioIsSet() const
{
    return m_ScenarioIsSet;
}
void PurchaseTaxByTypeDetail::unsetScenario()
{
    m_ScenarioIsSet = false;
}
double PurchaseTaxByTypeDetail::getSubtotalTaxable() const
{
    return m_SubtotalTaxable;
}
void PurchaseTaxByTypeDetail::setSubtotalTaxable(double value)
{
    m_SubtotalTaxable = value;
    m_SubtotalTaxableIsSet = true;
}
bool PurchaseTaxByTypeDetail::subtotalTaxableIsSet() const
{
    return m_SubtotalTaxableIsSet;
}
void PurchaseTaxByTypeDetail::unsetSubtotalTaxable()
{
    m_SubtotalTaxableIsSet = false;
}
double PurchaseTaxByTypeDetail::getSubtotalExempt() const
{
    return m_SubtotalExempt;
}
void PurchaseTaxByTypeDetail::setSubtotalExempt(double value)
{
    m_SubtotalExempt = value;
    m_SubtotalExemptIsSet = true;
}
bool PurchaseTaxByTypeDetail::subtotalExemptIsSet() const
{
    return m_SubtotalExemptIsSet;
}
void PurchaseTaxByTypeDetail::unsetSubtotalExempt()
{
    m_SubtotalExemptIsSet = false;
}
double PurchaseTaxByTypeDetail::getRate() const
{
    return m_Rate;
}
void PurchaseTaxByTypeDetail::setRate(double value)
{
    m_Rate = value;
    m_RateIsSet = true;
}
bool PurchaseTaxByTypeDetail::rateIsSet() const
{
    return m_RateIsSet;
}
void PurchaseTaxByTypeDetail::unsetRate()
{
    m_RateIsSet = false;
}
double PurchaseTaxByTypeDetail::getTax() const
{
    return m_Tax;
}
void PurchaseTaxByTypeDetail::setTax(double value)
{
    m_Tax = value;
    m_TaxIsSet = true;
}
bool PurchaseTaxByTypeDetail::taxIsSet() const
{
    return m_TaxIsSet;
}
void PurchaseTaxByTypeDetail::unsetTax()
{
    m_TaxIsSet = false;
}
utility::string_t PurchaseTaxByTypeDetail::getExemptionCode() const
{
    return m_ExemptionCode;
}
void PurchaseTaxByTypeDetail::setExemptionCode(utility::string_t value)
{
    m_ExemptionCode = value;
    m_ExemptionCodeIsSet = true;
}
bool PurchaseTaxByTypeDetail::exemptionCodeIsSet() const
{
    return m_ExemptionCodeIsSet;
}
void PurchaseTaxByTypeDetail::unsetExemptionCode()
{
    m_ExemptionCodeIsSet = false;
}
std::vector<utility::string_t>& PurchaseTaxByTypeDetail::getSignificantLocations()
{
    return m_SignificantLocations;
}
bool PurchaseTaxByTypeDetail::significantLocationsIsSet() const
{
    return m_SignificantLocationsIsSet;
}
void PurchaseTaxByTypeDetail::unsetSignificantLocations()
{
    m_SignificantLocationsIsSet = false;
}
utility::string_t PurchaseTaxByTypeDetail::getTaxRuleType() const
{
    return m_TaxRuleType;
}
void PurchaseTaxByTypeDetail::setTaxRuleType(utility::string_t value)
{
    m_TaxRuleType = value;
    m_TaxRuleTypeIsSet = true;
}
bool PurchaseTaxByTypeDetail::taxRuleTypeIsSet() const
{
    return m_TaxRuleTypeIsSet;
}
void PurchaseTaxByTypeDetail::unsetTaxRuleType()
{
    m_TaxRuleTypeIsSet = false;
}
