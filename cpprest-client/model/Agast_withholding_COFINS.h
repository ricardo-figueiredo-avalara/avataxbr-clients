...
/// inform if this item is subject to withholding COFINS on service Transactions, by entity type, default true
/// </summary>
class  Agast_withholding_COFINS
    : public ModelBase
{
public:
    Agast_withholding_COFINS();
    virtual ~Agast_withholding_COFINS();
    ...
    /////////////////////////////////////////////
    /// Agast_withholding_COFINS members
...
#endif /* Agast_withholding_COFINS_H_ */
