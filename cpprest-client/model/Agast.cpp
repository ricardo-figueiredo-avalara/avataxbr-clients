...
web::json::value Agast::toJson() const
{
...
void Agast::fromJson(web::json::value& val)
{
...
void Agast::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Agast::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
utility::string_t Agast::getCode() const
{
    return m_Code;
}
void Agast::setCode(utility::string_t value)
{
    m_Code = value;
    
}
utility::string_t Agast::getDescription() const
{
    return m_Description;
}
void Agast::setDescription(utility::string_t value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}
bool Agast::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}
void Agast::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t Agast::getHsCode() const
{
    return m_HsCode;
}
void Agast::setHsCode(utility::string_t value)
{
    m_HsCode = value;
    m_HsCodeIsSet = true;
}
bool Agast::hsCodeIsSet() const
{
    return m_HsCodeIsSet;
}
void Agast::unsetHsCode()
{
    m_HsCodeIsSet = false;
}
int32_t Agast::getEx() const
{
    return m_Ex;
}
void Agast::setEx(int32_t value)
{
    m_Ex = value;
    m_ExIsSet = true;
}
bool Agast::exIsSet() const
{
    return m_ExIsSet;
}
void Agast::unsetEx()
...
utility::string_t Agast::getCest() const
{
    return m_Cest;
}
void Agast::setCest(utility::string_t value)
{
    m_Cest = value;
    m_CestIsSet = true;
}
bool Agast::cestIsSet() const
{
    return m_CestIsSet;
}
void Agast::unsetCest()
{
    m_CestIsSet = false;
}
utility::string_t Agast::getCean() const
{
    return m_Cean;
}
void Agast::setCean(utility::string_t value)
{
    m_Cean = value;
    m_CeanIsSet = true;
}
bool Agast::ceanIsSet() const
{
    return m_CeanIsSet;
}
void Agast::unsetCean()
{
    m_CeanIsSet = false;
}
std::shared_ptr<Agast_codeType> Agast::getCodeType() const
{
    return m_CodeType;
}
void Agast::setCodeType(std::shared_ptr<Agast_codeType> value)
{
    m_CodeType = value;
    m_CodeTypeIsSet = true;
}
bool Agast::codeTypeIsSet() const
{
    return m_CodeTypeIsSet;
}
void Agast::unsetCodeType()
{
    m_CodeTypeIsSet = false;
}
utility::string_t Agast::getCstIPI() const
{
    return m_CstIPI;
}
void Agast::setCstIPI(utility::string_t value)
{
    m_CstIPI = value;
    m_CstIPIIsSet = true;
}
bool Agast::cstIPIIsSet() const
{
    return m_CstIPIIsSet;
}
void Agast::unsetCstIPI()
{
    m_CstIPIIsSet = false;
}
utility::string_t Agast::getIpiLegalTaxClass() const
{
    return m_IpiLegalTaxClass;
}
void Agast::setIpiLegalTaxClass(utility::string_t value)
{
    m_IpiLegalTaxClass = value;
    m_IpiLegalTaxClassIsSet = true;
}
bool Agast::ipiLegalTaxClassIsSet() const
{
    return m_IpiLegalTaxClassIsSet;
}
void Agast::unsetIpiLegalTaxClass()
{
    m_IpiLegalTaxClassIsSet = false;
}
utility::string_t Agast::getPisCofinsTaxReporting() const
{
    return m_PisCofinsTaxReporting;
}
void Agast::setPisCofinsTaxReporting(utility::string_t value)
{
    m_PisCofinsTaxReporting = value;
    m_PisCofinsTaxReportingIsSet = true;
}
bool Agast::pisCofinsTaxReportingIsSet() const
{
    return m_PisCofinsTaxReportingIsSet;
}
void Agast::unsetPisCofinsTaxReporting()
{
    m_PisCofinsTaxReportingIsSet = false;
}
utility::string_t Agast::getAccruablePISTaxation() const
{
    return m_AccruablePISTaxation;
}
void Agast::setAccruablePISTaxation(utility::string_t value)
{
    m_AccruablePISTaxation = value;
    m_AccruablePISTaxationIsSet = true;
}
bool Agast::accruablePISTaxationIsSet() const
{
    return m_AccruablePISTaxationIsSet;
}
void Agast::unsetAccruablePISTaxation()
{
    m_AccruablePISTaxationIsSet = false;
}
...
void Agast::setAccruableCOFINSTaxation(utility::string_t value)
{
    m_AccruableCOFINSTaxation = value;
    m_AccruableCOFINSTaxationIsSet = true;
}
bool Agast::accruableCOFINSTaxationIsSet() const
{
    return m_AccruableCOFINSTaxationIsSet;
}
void Agast::unsetAccruableCOFINSTaxation()
{
    m_AccruableCOFINSTaxationIsSet = false;
}
...
void Agast::setAccruableCSLLTaxation(utility::string_t value)
{
    m_AccruableCSLLTaxation = value;
    m_AccruableCSLLTaxationIsSet = true;
}
bool Agast::accruableCSLLTaxationIsSet() const
{
...
void Agast::setIssDueatDestination(bool value)
{
    m_IssDueatDestination = value;
    m_IssDueatDestinationIsSet = true;
}
bool Agast::issDueatDestinationIsSet() const
{
    return m_IssDueatDestinationIsSet;
}
void Agast::unsetIssDueatDestination()
{
    m_IssDueatDestinationIsSet = false;
}
bool Agast::getPisCofinsCreditNotAllowed() const
{
    return m_PisCofinsCreditNotAllowed;
}
void Agast::setPisCofinsCreditNotAllowed(bool value)
{
    m_PisCofinsCreditNotAllowed = value;
    m_PisCofinsCreditNotAllowedIsSet = true;
}
bool Agast::pisCofinsCreditNotAllowedIsSet() const
{
    return m_PisCofinsCreditNotAllowedIsSet;
}
void Agast::unsetPisCofinsCreditNotAllowed()
{
    m_PisCofinsCreditNotAllowedIsSet = false;
}
utility::string_t Agast::getIssTaxation() const
{
    return m_IssTaxation;
}
void Agast::setIssTaxation(utility::string_t value)
{
    m_IssTaxation = value;
    m_IssTaxationIsSet = true;
}
bool Agast::issTaxationIsSet() const
{
    return m_IssTaxationIsSet;
}
void Agast::unsetIssTaxation()
{
    m_IssTaxationIsSet = false;
}
std::vector<std::shared_ptr<TaxTypeRate>>& Agast::getFederalTaxRate()
{
    return m_FederalTaxRate;
}
bool Agast::federalTaxRateIsSet() const
{
    return m_FederalTaxRateIsSet;
}
void Agast::unsetFederalTaxRate()
{
    m_FederalTaxRateIsSet = false;
}
utility::string_t Agast::getSpecialProductClass() const
{
    return m_SpecialProductClass;
}
void Agast::setSpecialProductClass(utility::string_t value)
{
    m_SpecialProductClass = value;
    m_SpecialProductClassIsSet = true;
}
bool Agast::specialProductClassIsSet() const
{
    return m_SpecialProductClassIsSet;
}
void Agast::unsetSpecialProductClass()
{
    m_SpecialProductClassIsSet = false;
}
std::vector<std::shared_ptr<Agast_icmsConf>>& Agast::getIcmsConf()
{
    return m_IcmsConf;
}
bool Agast::icmsConfIsSet() const
{
    return m_IcmsConfIsSet;
}
void Agast::unsetIcmsConf()
{
    m_IcmsConfIsSet = false;
}
