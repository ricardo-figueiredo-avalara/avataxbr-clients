...
/// inform if this item is subject to withholding PIS on service Transactions, by entity type, default true
/// </summary>
class  Agast_withholding_PIS
    : public ModelBase
{
public:
    Agast_withholding_PIS();
    virtual ~Agast_withholding_PIS();
...
#endif /* Agast_withholding_PIS_H_ */
