...
#ifndef PayRecHeader_H_
#define PayRecHeader_H_
...
public:
    ...
    /// </summary>
    utility::string_t getPaymentMode() const;
    void setPaymentMode(utility::string_t value);
...
utility::string_t m_VendorCode;
    utility::string_t m_PaymentMode;
    };
