...
#ifndef PurchaseTaxByType_H_
#define PurchaseTaxByType_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<TaxByTypeTax> getInssAr() const;
    void setInssAr(std::shared_ptr<TaxByTypeTax> value);
...
std::shared_ptr<TaxByTypeTax> m_InssRf;
    bool m_InssRfIsSet;
std::shared_ptr<TaxByTypeTax> m_InssAr;
    bool m_InssArIsSet;
