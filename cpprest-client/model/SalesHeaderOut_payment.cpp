...
SalesHeaderOut_payment::SalesHeaderOut_payment()
{
    m_TermsIsSet = false;
...
void SalesHeaderOut_payment::validate()
{
    // TODO: implement validation
}

web::json::value SalesHeaderOut_payment::toJson() const
{
...
void SalesHeaderOut_payment::fromJson(web::json::value& val)
{
...
void SalesHeaderOut_payment::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SalesHeaderOut_payment::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
std::shared_ptr<PaymentTerms> SalesHeaderOut_payment::getTerms() const
{
    return m_Terms;
}
void SalesHeaderOut_payment::setTerms(std::shared_ptr<PaymentTerms> value)
{
    m_Terms = value;
    m_TermsIsSet = true;
}
bool SalesHeaderOut_payment::termsIsSet() const
{
    return m_TermsIsSet;
}
void SalesHeaderOut_payment::unsetTerms()
{
    m_TermsIsSet = false;
}
std::shared_ptr<WithholdingMode> SalesHeaderOut_payment::getWithholdingMode() const
{
    return m_WithholdingMode;
}
void SalesHeaderOut_payment::setWithholdingMode(std::shared_ptr<WithholdingMode> value)
{
    m_WithholdingMode = value;
    m_WithholdingModeIsSet = true;
}
bool SalesHeaderOut_payment::withholdingModeIsSet() const
{
    return m_WithholdingModeIsSet;
}
void SalesHeaderOut_payment::unsetWithholdingMode()
{
    m_WithholdingModeIsSet = false;
}
std::vector<std::shared_ptr<InstallmentComplete>>& SalesHeaderOut_payment::getInstallments()
{
    return m_Installments;
}
bool SalesHeaderOut_payment::installmentsIsSet() const
{
    return m_InstallmentsIsSet;
}
void SalesHeaderOut_payment::unsetInstallments()
{
    m_InstallmentsIsSet = false;
}
