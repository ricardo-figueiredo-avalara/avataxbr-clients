...
#ifndef LineForSefazGoods_H_
#define LineForSefazGoods_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<AgastExtendForSefaz> getExtend() const;
    void setExtend(std::shared_ptr<AgastExtendForSefaz> value);
...
std::shared_ptr<AgastExtendForSefaz> m_Extend;
    bool m_ExtendIsSet;
};
