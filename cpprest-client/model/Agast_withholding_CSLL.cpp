...
Agast_withholding_CSLL::Agast_withholding_CSLL()
{
    m_LegalReason = U("");
...
void Agast_withholding_CSLL::validate()
{
    // TODO: implement validation
}

web::json::value Agast_withholding_CSLL::toJson() const
{
...
void Agast_withholding_CSLL::fromJson(web::json::value& val)
{
...
void Agast_withholding_CSLL::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void Agast_withholding_CSLL::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
utility::string_t Agast_withholding_CSLL::getLegalReason() const
{
    return m_LegalReason;
}
void Agast_withholding_CSLL::setLegalReason(utility::string_t value)
{
    m_LegalReason = value;
    m_LegalReasonIsSet = true;
}
bool Agast_withholding_CSLL::legalReasonIsSet() const
{
    return m_LegalReasonIsSet;
}
void Agast_withholding_CSLL::unsetLegalReason()
{
    m_LegalReasonIsSet = false;
}
bool Agast_withholding_CSLL::getBusiness() const
{
    return m_Business;
}
void Agast_withholding_CSLL::setBusiness(bool value)
{
    m_Business = value;
    m_BusinessIsSet = true;
}
bool Agast_withholding_CSLL::businessIsSet() const
{
    return m_BusinessIsSet;
}
void Agast_withholding_CSLL::unsetBusiness()
{
    m_BusinessIsSet = false;
}
utility::string_t Agast_withholding_CSLL::getBusinessLegalReason() const
{
    return m_BusinessLegalReason;
}
void Agast_withholding_CSLL::setBusinessLegalReason(utility::string_t value)
{
    m_BusinessLegalReason = value;
    m_BusinessLegalReasonIsSet = true;
}
bool Agast_withholding_CSLL::businessLegalReasonIsSet() const
{
    return m_BusinessLegalReasonIsSet;
}
void Agast_withholding_CSLL::unsetBusinessLegalReason()
{
    m_BusinessLegalReasonIsSet = false;
}
bool Agast_withholding_CSLL::getFederalGovernment() const
{
    return m_FederalGovernment;
}
void Agast_withholding_CSLL::setFederalGovernment(bool value)
{
    m_FederalGovernment = value;
    m_FederalGovernmentIsSet = true;
}
bool Agast_withholding_CSLL::federalGovernmentIsSet() const
{
    return m_FederalGovernmentIsSet;
}
void Agast_withholding_CSLL::unsetFederalGovernment()
{
    m_FederalGovernmentIsSet = false;
}
utility::string_t Agast_withholding_CSLL::getFederalGovernmentLegalReason() const
{
    return m_FederalGovernmentLegalReason;
}
void Agast_withholding_CSLL::setFederalGovernmentLegalReason(utility::string_t value)
{
    m_FederalGovernmentLegalReason = value;
    m_FederalGovernmentLegalReasonIsSet = true;
}
bool Agast_withholding_CSLL::federalGovernmentLegalReasonIsSet() const
{
    return m_FederalGovernmentLegalReasonIsSet;
}
void Agast_withholding_CSLL::unsetFederalGovernmentLegalReason()
{
    m_FederalGovernmentLegalReasonIsSet = false;
}
bool Agast_withholding_CSLL::getStateGovernment() const
{
    return m_StateGovernment;
}
void Agast_withholding_CSLL::setStateGovernment(bool value)
{
    m_StateGovernment = value;
    m_StateGovernmentIsSet = true;
}
bool Agast_withholding_CSLL::stateGovernmentIsSet() const
{
    return m_StateGovernmentIsSet;
}
void Agast_withholding_CSLL::unsetStateGovernment()
{
    m_StateGovernmentIsSet = false;
}
utility::string_t Agast_withholding_CSLL::getStateGovernmentLegalReason() const
{
    return m_StateGovernmentLegalReason;
}
void Agast_withholding_CSLL::setStateGovernmentLegalReason(utility::string_t value)
{
    m_StateGovernmentLegalReason = value;
    m_StateGovernmentLegalReasonIsSet = true;
}
bool Agast_withholding_CSLL::stateGovernmentLegalReasonIsSet() const
{
    return m_StateGovernmentLegalReasonIsSet;
}
void Agast_withholding_CSLL::unsetStateGovernmentLegalReason()
{
    m_StateGovernmentLegalReasonIsSet = false;
}
bool Agast_withholding_CSLL::getCityGovernment() const
{
    return m_CityGovernment;
}
void Agast_withholding_CSLL::setCityGovernment(bool value)
{
    m_CityGovernment = value;
    m_CityGovernmentIsSet = true;
}
bool Agast_withholding_CSLL::cityGovernmentIsSet() const
{
    return m_CityGovernmentIsSet;
}
void Agast_withholding_CSLL::unsetCityGovernment()
{
    m_CityGovernmentIsSet = false;
}
utility::string_t Agast_withholding_CSLL::getCityGovernmentLegalReason() const
{
    return m_CityGovernmentLegalReason;
}
void Agast_withholding_CSLL::setCityGovernmentLegalReason(utility::string_t value)
{
    m_CityGovernmentLegalReason = value;
    m_CityGovernmentLegalReasonIsSet = true;
}
bool Agast_withholding_CSLL::cityGovernmentLegalReasonIsSet() const
{
    return m_CityGovernmentLegalReasonIsSet;
}
void Agast_withholding_CSLL::unsetCityGovernmentLegalReason()
{
    m_CityGovernmentLegalReasonIsSet = false;
}
