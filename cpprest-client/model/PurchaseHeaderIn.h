...
#ifndef PurchaseHeaderIn_H_
#define PurchaseHeaderIn_H_
...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<PurchaseHeaderIn_payment> getPayment() const;
    void setPayment(std::shared_ptr<PurchaseHeaderIn_payment> value);
...
std::shared_ptr<PurchaseEntity> m_Entity;
    bool m_EntityIsSet;
std::shared_ptr<PurchaseHeaderIn_payment> m_Payment;
    bool m_PaymentIsSet;
