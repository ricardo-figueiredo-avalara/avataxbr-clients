...
void SalesCalculatedTaxSummaryForService::validate()
{
    // TODO: implement validation
}

web::json::value SalesCalculatedTaxSummaryForService::toJson() const
{
...
void SalesCalculatedTaxSummaryForService::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(U("taxByType")))
    {
        ...
        {
            std::shared_ptr<SalesCalculatedTaxSummaryForService_taxByType> newItem(new SalesCalculatedTaxSummaryForService_taxByType());
...
void SalesCalculatedTaxSummaryForService::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
void SalesCalculatedTaxSummaryForService::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix[namePrefix.size() - 1] != U('.'))
    {
...
int32_t SalesCalculatedTaxSummaryForService::getNumberOfLines() const
{
    return m_NumberOfLines;
}
void SalesCalculatedTaxSummaryForService::setNumberOfLines(int32_t value)
{
    m_NumberOfLines = value;
    m_NumberOfLinesIsSet = true;
}
bool SalesCalculatedTaxSummaryForService::numberOfLinesIsSet() const
{
    return m_NumberOfLinesIsSet;
}
void SalesCalculatedTaxSummaryForService::unsetNumberOfLines()
{
    m_NumberOfLinesIsSet = false;
}
double SalesCalculatedTaxSummaryForService::getSubtotal() const
{
    return m_Subtotal;
}
void SalesCalculatedTaxSummaryForService::setSubtotal(double value)
{
    m_Subtotal = value;
    m_SubtotalIsSet = true;
}
bool SalesCalculatedTaxSummaryForService::subtotalIsSet() const
{
    return m_SubtotalIsSet;
}
void SalesCalculatedTaxSummaryForService::unsetSubtotal()
{
    m_SubtotalIsSet = false;
}
double SalesCalculatedTaxSummaryForService::getTotalTax() const
{
    return m_TotalTax;
}
void SalesCalculatedTaxSummaryForService::setTotalTax(double value)
{
    m_TotalTax = value;
    m_TotalTaxIsSet = true;
}
bool SalesCalculatedTaxSummaryForService::totalTaxIsSet() const
{
    return m_TotalTaxIsSet;
}
void SalesCalculatedTaxSummaryForService::unsetTotalTax()
{
    m_TotalTaxIsSet = false;
}
double SalesCalculatedTaxSummaryForService::getGrandTotal() const
{
    return m_GrandTotal;
}
void SalesCalculatedTaxSummaryForService::setGrandTotal(double value)
{
    m_GrandTotal = value;
    m_GrandTotalIsSet = true;
}
bool SalesCalculatedTaxSummaryForService::grandTotalIsSet() const
{
    return m_GrandTotalIsSet;
}
void SalesCalculatedTaxSummaryForService::unsetGrandTotal()
{
    m_GrandTotalIsSet = false;
}
std::shared_ptr<SalesCalculatedTaxSummaryForService_taxByType> SalesCalculatedTaxSummaryForService::getTaxByType() const
{
    return m_TaxByType;
}
void SalesCalculatedTaxSummaryForService::setTaxByType(std::shared_ptr<SalesCalculatedTaxSummaryForService_taxByType> value)
{
    m_TaxByType = value;
    m_TaxByTypeIsSet = true;
}
bool SalesCalculatedTaxSummaryForService::taxByTypeIsSet() const
{
    return m_TaxByTypeIsSet;
}
void SalesCalculatedTaxSummaryForService::unsetTaxByType()
{
    m_TaxByTypeIsSet = false;
}
