# WWW::SwaggerClient::Object::LineForGoodsIcmsTaxRelief
...
**tax_base_discount** | **double** | ICMS Tax base rate discount  (desconto na base do ICMS referetne a desoneração) | [optional] 
**tax_amount** | **double** | Amount for Icms Relief (desoneração) | [optional] 
