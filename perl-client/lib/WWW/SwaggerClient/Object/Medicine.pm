...
#
package WWW::SwaggerClient::Object::Medicine;
...
__PACKAGE__->method_documentation({
    ...
    'max_value_to_end_user' => {
    	datatype => 'double',
    	base_name => 'maxValueToEndUser',
