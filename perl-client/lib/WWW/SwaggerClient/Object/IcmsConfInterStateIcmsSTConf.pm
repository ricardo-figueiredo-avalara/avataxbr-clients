...
#
package WWW::SwaggerClient::Object::IcmsConfInterStateIcmsSTConf;
...
__PACKAGE__->method_documentation({
    'protocol_type' => {
    	datatype => 'string',
    	base_name => 'protocolType',
    	description => '',
    	format => '',
    	read_only => '',
    		},
    'has_reduction_of_mva_for_simples' => {
    	datatype => 'boolean',
    	base_name => 'hasReductionOfMVAForSimples',
    	description => 'inform that substituted is tax regime Simplified the operation MVA will be reduced',
    	format => '',
    	read_only => '',
    		},
    'reduction_of_mva_for_simples' => {
    	datatype => 'double',
    	base_name => 'reductionOfMVAForSimples',
    ...
    'icms_st_base_discount' => {
    	datatype => 'double',
    	base_name => 'icmsStBaseDiscount',
