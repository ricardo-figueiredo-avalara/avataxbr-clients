...
#
package WWW::SwaggerClient::Object::CalculatedTaxSummaryForGoods;
...
__PACKAGE__->method_documentation({
    ...
    'tax_by_type' => {
    	datatype => 'CalculatedTaxSummaryForGoodsTaxByType',
    	base_name => 'taxByType',
    	description => '',
    	format => '',
    	read_only => '',
