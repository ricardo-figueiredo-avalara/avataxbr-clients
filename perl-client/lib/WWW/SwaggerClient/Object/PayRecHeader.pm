...
#
package WWW::SwaggerClient::Object::PayRecHeader;
...
__PACKAGE__->method_documentation({
    ...
    'payment_mode' => {
    	...
    	description => '- &#39;CALCULATE&#39; - &#39;ASIS&#39; When ASIS, the transaction is stored without executing tax determination (no Calculation). ',
    	format => '',
    	read_only => '',
    		},
});
