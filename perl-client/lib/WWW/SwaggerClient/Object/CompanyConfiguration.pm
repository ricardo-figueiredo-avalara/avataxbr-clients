...
#
package WWW::SwaggerClient::Object::CompanyConfiguration;
...
__PACKAGE__->method_documentation({
    ...
    'certificateexpiration' => {
    	datatype => 'DateTime',
    	base_name => 'certificateexpiration',
    ...
    'tp_imp_n_fe' => {
    	datatype => 'string',
    	base_name => 'tpImpNFe',
    	description => 'how the document will be printed - &#39;0&#39; # without DANFE; - &#39;1&#39; # DANFe Letter; - &#39;2&#39; # DANFe Landscape; ',
    	format => '',
    	read_only => '',
    		},
    'tp_imp_nf_ce' => {
    	datatype => 'string',
    	base_name => 'tpImpNFCe',
    	description => 'how the document will be printed - &#39;0&#39; # without DANFE; - &#39;4&#39; # DANFe NFC-e; - &#39;5&#39; # DANFe NFC-e e-mail ',
    	format => '',
    	read_only => '',
    		},
});
