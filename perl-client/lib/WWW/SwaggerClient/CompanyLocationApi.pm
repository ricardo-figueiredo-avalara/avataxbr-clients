...
#
package WWW::SwaggerClient::CompanyLocationApi;
...
# @param string $code Location Code (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'companies_company_id_locations_code_get' } = { 
    	summary => '',
        params => $params,
        returns => 'Location',
        };
...
# @return Location
#
sub companies_company_id_locations_code_get {
    my ($self, %args) = @_;

    # verify the required parameter 'company_id' is set
    unless (exists $args{'company_id'}) {
      croak("Missing the required parameter 'company_id' when calling companies_company_id_locations_code_get");
    }

    # verify the required parameter 'code' is set
    unless (exists $args{'code'}) {
      croak("Missing the required parameter 'code' when calling companies_company_id_locations_code_get");
    }

    # parse inputs
    my $_resource_path = '/companies/{companyId}/locations/{code}';
...
# @param string $x_pagination_sort  (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'companies_company_id_locations_get' } = { 
    	summary => '',
        params => $params,
...
#
sub companies_company_id_locations_get {
    my ($self, %args) = @_;

    # verify the required parameter 'company_id' is set
    unless (exists $args{'company_id'}) {
      croak("Missing the required parameter 'company_id' when calling companies_company_id_locations_get");
    }

    # parse inputs
    my $_resource_path = '/companies/{companyId}/locations';
    $_resource_path =~ s/{format}/json/; # default format to json
...
# @param Location $body Transaction Message (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'create_location' } = { 
...
sub create_location {
    ...
    # verify the required parameter 'company_id' is set
    unless (exists $args{'company_id'}) {
      croak("Missing the required parameter 'company_id' when calling create_location");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling create_location");
    }
...
sub delete_location {
    ...
    # verify the required parameter 'company_id' is set
    unless (exists $args{'company_id'}) {
      croak("Missing the required parameter 'company_id' when calling delete_location");
    }

    # verify the required parameter 'code' is set
    unless (exists $args{'code'}) {
      croak("Missing the required parameter 'code' when calling delete_location");
    }
...
sub update_location {
    ...
    # verify the required parameter 'company_id' is set
    unless (exists $args{'company_id'}) {
      croak("Missing the required parameter 'company_id' when calling update_location");
    }

    # verify the required parameter 'code' is set
    unless (exists $args{'code'}) {
      croak("Missing the required parameter 'code' when calling update_location");
    }

    # verify the required parameter 'body' is set
    unless (exists $args{'body'}) {
      croak("Missing the required parameter 'body' when calling update_location");
    }
