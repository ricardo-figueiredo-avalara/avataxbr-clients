...
public enum TaxTypeEnum {
    ...
    @XmlEnumValue("pis") PIS(String.valueOf("pis")), @XmlEnumValue("pisRf") PISRF(String.valueOf("pisRf")), @XmlEnumValue("cofins") COFINS(String.valueOf("cofins")), @XmlEnumValue("cofinsRf") COFINSRF(String.valueOf("cofinsRf")), @XmlEnumValue("csll") CSLL(String.valueOf("csll")), @XmlEnumValue("csllRf") CSLLRF(String.valueOf("csllRf")), @XmlEnumValue("irrf") IRRF(String.valueOf("irrf")), @XmlEnumValue("inssAr") INSSAR(String.valueOf("inssAr")), @XmlEnumValue("inssRf") INSSRF(String.valueOf("inssRf")), @XmlEnumValue("issRf") ISSRF(String.valueOf("issRf"));
