...
public class InvoiceSettingsApi {
  ...
  */
  public InlineResponse2004 invoiceSettings () throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;

    // create path and map variables
    String path = "/invoices/settings".replaceAll("\\{format\\}","json");
  ...
  */
  public void invoiceSettings (final Response.Listener<InlineResponse2004> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
