...
public class PurchaseTaxByTypeDetail {
  ...
  public enum TaxTypeEnum {
     pis,  pisRf,  cofins,  cofinsRf,  csll,  csllRf,  irrf,  inssAr,  inssRf,  issRf, 
  };
   ...
   **/
  @ApiModelProperty(value = "Tax identificator - 'pis' - 'pisRf' - 'cofins' - 'cofinsRf' - 'csll' - 'csllRf' - 'irrf' - 'inssAr' - 'inssRf' - 'issRf' ")
  ...
  public boolean equals(Object o) {
    ...
    return (this.locationType == null ? purchaseTaxByTypeDetail.locationType == null : this.locationType.equals(purchaseTaxByTypeDetail.locationType)) &&
        (this.jurisdictionName == null ? purchaseTaxByTypeDetail.jurisdictionName == null : this.jurisdictionName.equals(purchaseTaxByTypeDetail.jurisdictionName)) &&
        (this.jurisdictionType == null ? purchaseTaxByTypeDetail.jurisdictionType == null : this.jurisdictionType.equals(purchaseTaxByTypeDetail.jurisdictionType)) &&
        (this.taxType == null ? purchaseTaxByTypeDetail.taxType == null : this.taxType.equals(purchaseTaxByTypeDetail.taxType)) &&
        (this.rateType == null ? purchaseTaxByTypeDetail.rateType == null : this.rateType.equals(purchaseTaxByTypeDetail.rateType)) &&
        (this.scenario == null ? purchaseTaxByTypeDetail.scenario == null : this.scenario.equals(purchaseTaxByTypeDetail.scenario)) &&
        (this.subtotalTaxable == null ? purchaseTaxByTypeDetail.subtotalTaxable == null : this.subtotalTaxable.equals(purchaseTaxByTypeDetail.subtotalTaxable)) &&
        (this.subtotalExempt == null ? purchaseTaxByTypeDetail.subtotalExempt == null : this.subtotalExempt.equals(purchaseTaxByTypeDetail.subtotalExempt)) &&
        (this.rate == null ? purchaseTaxByTypeDetail.rate == null : this.rate.equals(purchaseTaxByTypeDetail.rate)) &&
        (this.tax == null ? purchaseTaxByTypeDetail.tax == null : this.tax.equals(purchaseTaxByTypeDetail.tax)) &&
        (this.exemptionCode == null ? purchaseTaxByTypeDetail.exemptionCode == null : this.exemptionCode.equals(purchaseTaxByTypeDetail.exemptionCode)) &&
        (this.significantLocations == null ? purchaseTaxByTypeDetail.significantLocations == null : this.significantLocations.equals(purchaseTaxByTypeDetail.significantLocations)) &&
        (this.taxRuleType == null ? purchaseTaxByTypeDetail.taxRuleType == null : this.taxRuleType.equals(purchaseTaxByTypeDetail.taxRuleType));
  }
