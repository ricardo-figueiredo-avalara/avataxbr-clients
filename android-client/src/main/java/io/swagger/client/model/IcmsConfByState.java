...
public class IcmsConfByState {
  ...
  public boolean equals(Object o) {
    ...
    return (this.code == null ? icmsConfByState.code == null : this.code.equals(icmsConfByState.code)) &&
        (this.state == null ? icmsConfByState.state == null : this.state.equals(icmsConfByState.state)) &&
        (this.name == null ? icmsConfByState.name == null : this.name.equals(icmsConfByState.name)) &&
        (this.startDate == null ? icmsConfByState.startDate == null : this.startDate.equals(icmsConfByState.startDate)) &&
        (this.expirationDate == null ? icmsConfByState.expirationDate == null : this.expirationDate.equals(icmsConfByState.expirationDate)) &&
        (this.inactive == null ? icmsConfByState.inactive == null : this.inactive.equals(icmsConfByState.inactive)) &&
        (this.subjectToST == null ? icmsConfByState.subjectToST == null : this.subjectToST.equals(icmsConfByState.subjectToST)) &&
        (this.icmsCST == null ? icmsConfByState.icmsCST == null : this.icmsCST.equals(icmsConfByState.icmsCST)) &&
        (this.calcMode == null ? icmsConfByState.calcMode == null : this.calcMode.equals(icmsConfByState.calcMode)) &&
        (this.discountRateForMonoPhase == null ? icmsConfByState.discountRateForMonoPhase == null : this.discountRateForMonoPhase.equals(icmsConfByState.discountRateForMonoPhase)) &&
        (this.rate == null ? icmsConfByState.rate == null : this.rate.equals(icmsConfByState.rate)) &&
        (this.icmsBaseDiscount == null ? icmsConfByState.icmsBaseDiscount == null : this.icmsBaseDiscount.equals(icmsConfByState.icmsBaseDiscount)) &&
        (this.msrp == null ? icmsConfByState.msrp == null : this.msrp.equals(icmsConfByState.msrp)) &&
        (this.mvaRate == null ? icmsConfByState.mvaRate == null : this.mvaRate.equals(icmsConfByState.mvaRate)) &&
        (this.msrpUnit == null ? icmsConfByState.msrpUnit == null : this.msrpUnit.equals(icmsConfByState.msrpUnit)) &&
        (this.icmsLegalReason == null ? icmsConfByState.icmsLegalReason == null : this.icmsLegalReason.equals(icmsConfByState.icmsLegalReason)) &&
        (this.fcpRate == null ? icmsConfByState.fcpRate == null : this.fcpRate.equals(icmsConfByState.fcpRate)) &&
        (this.icmsSTConf == null ? icmsConfByState.icmsSTConf == null : this.icmsSTConf.equals(icmsConfByState.icmsSTConf)) &&
        (this.icmsInterStateConf == null ? icmsConfByState.icmsInterStateConf == null : this.icmsInterStateConf.equals(icmsConfByState.icmsInterStateConf));
  }
