...
public class EntityLocation {
  ...
  public boolean equals(Object o) {
    ...
    return (this.street == null ? entityLocation.street == null : this.street.equals(entityLocation.street)) &&
        (this.neighborhood == null ? entityLocation.neighborhood == null : this.neighborhood.equals(entityLocation.neighborhood)) &&
        (this.zipcode == null ? entityLocation.zipcode == null : this.zipcode.equals(entityLocation.zipcode)) &&
        (this.cityCode == null ? entityLocation.cityCode == null : this.cityCode.equals(entityLocation.cityCode)) &&
        (this.cityName == null ? entityLocation.cityName == null : this.cityName.equals(entityLocation.cityName)) &&
        (this.state == null ? entityLocation.state == null : this.state.equals(entityLocation.state)) &&
        (this.countryCode == null ? entityLocation.countryCode == null : this.countryCode.equals(entityLocation.countryCode)) &&
        (this.country == null ? entityLocation.country == null : this.country.equals(entityLocation.country));
  }
