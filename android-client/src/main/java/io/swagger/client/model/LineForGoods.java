...
public class LineForGoods {
  ...
  public boolean equals(Object o) {
    ...
    return (this.lineCode == null ? lineForGoods.lineCode == null : this.lineCode.equals(lineForGoods.lineCode)) &&
        (this.itemCode == null ? lineForGoods.itemCode == null : this.itemCode.equals(lineForGoods.itemCode)) &&
        (this.avalaraGoodsAndServicesType == null ? lineForGoods.avalaraGoodsAndServicesType == null : this.avalaraGoodsAndServicesType.equals(lineForGoods.avalaraGoodsAndServicesType)) &&
        (this.numberOfItems == null ? lineForGoods.numberOfItems == null : this.numberOfItems.equals(lineForGoods.numberOfItems)) &&
        (this.returnedPercentageAmount == null ? lineForGoods.returnedPercentageAmount == null : this.returnedPercentageAmount.equals(lineForGoods.returnedPercentageAmount)) &&
        (this.lineUnitPrice == null ? lineForGoods.lineUnitPrice == null : this.lineUnitPrice.equals(lineForGoods.lineUnitPrice)) &&
        (this.lineAmount == null ? lineForGoods.lineAmount == null : this.lineAmount.equals(lineForGoods.lineAmount)) &&
        (this.itemDescription == null ? lineForGoods.itemDescription == null : this.itemDescription.equals(lineForGoods.itemDescription)) &&
        (this.lineTaxedDiscount == null ? lineForGoods.lineTaxedDiscount == null : this.lineTaxedDiscount.equals(lineForGoods.lineTaxedDiscount)) &&
        (this.lineUntaxedDiscount == null ? lineForGoods.lineUntaxedDiscount == null : this.lineUntaxedDiscount.equals(lineForGoods.lineUntaxedDiscount)) &&
        (this.useType == null ? lineForGoods.useType == null : this.useType.equals(lineForGoods.useType)) &&
        (this.processScenario == null ? lineForGoods.processScenario == null : this.processScenario.equals(lineForGoods.processScenario)) &&
        (this.cfop == null ? lineForGoods.cfop == null : this.cfop.equals(lineForGoods.cfop)) &&
        (this.hasStockImpact == null ? lineForGoods.hasStockImpact == null : this.hasStockImpact.equals(lineForGoods.hasStockImpact)) &&
        (this.hasFinantialImpact == null ? lineForGoods.hasFinantialImpact == null : this.hasFinantialImpact.equals(lineForGoods.hasFinantialImpact)) &&
        (this.freightAmount == null ? lineForGoods.freightAmount == null : this.freightAmount.equals(lineForGoods.freightAmount)) &&
        (this.insuranceAmount == null ? lineForGoods.insuranceAmount == null : this.insuranceAmount.equals(lineForGoods.insuranceAmount)) &&
        (this.otherCostAmount == null ? lineForGoods.otherCostAmount == null : this.otherCostAmount.equals(lineForGoods.otherCostAmount)) &&
        (this.indTotType == null ? lineForGoods.indTotType == null : this.indTotType.equals(lineForGoods.indTotType)) &&
        (this.orderNumber == null ? lineForGoods.orderNumber == null : this.orderNumber.equals(lineForGoods.orderNumber)) &&
        (this.orderItemNumber == null ? lineForGoods.orderItemNumber == null : this.orderItemNumber.equals(lineForGoods.orderItemNumber)) &&
        (this.fciNumber == null ? lineForGoods.fciNumber == null : this.fciNumber.equals(lineForGoods.fciNumber)) &&
        (this.recopiNumber == null ? lineForGoods.recopiNumber == null : this.recopiNumber.equals(lineForGoods.recopiNumber)) &&
        (this.infAdProd == null ? lineForGoods.infAdProd == null : this.infAdProd.equals(lineForGoods.infAdProd)) &&
        (this.vehicle == null ? lineForGoods.vehicle == null : this.vehicle.equals(lineForGoods.vehicle)) &&
        (this.medicine == null ? lineForGoods.medicine == null : this.medicine.equals(lineForGoods.medicine)) &&
        (this.weapon == null ? lineForGoods.weapon == null : this.weapon.equals(lineForGoods.weapon)) &&
        (this.fuel == null ? lineForGoods.fuel == null : this.fuel.equals(lineForGoods.fuel)) &&
        (this.entityIsIcmsSubstitute == null ? lineForGoods.entityIsIcmsSubstitute == null : this.entityIsIcmsSubstitute.equals(lineForGoods.entityIsIcmsSubstitute)) &&
        (this.isTransportIcmsWithheld == null ? lineForGoods.isTransportIcmsWithheld == null : this.isTransportIcmsWithheld.equals(lineForGoods.isTransportIcmsWithheld)) &&
        (this.icmsTaxRelief == null ? lineForGoods.icmsTaxRelief == null : this.icmsTaxRelief.equals(lineForGoods.icmsTaxRelief)) &&
        (this.export == null ? lineForGoods.export == null : this.export.equals(lineForGoods.export)) &&
        (this.di == null ? lineForGoods.di == null : this.di.equals(lineForGoods.di)) &&
        (this.calculatedTax == null ? lineForGoods.calculatedTax == null : this.calculatedTax.equals(lineForGoods.calculatedTax));
  }
