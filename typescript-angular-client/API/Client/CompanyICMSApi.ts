...
namespace API.Client {
    ...
    export class CompanyICMSApi {
         ...
         */
        public companiesCompanyIdIcmsGet (companyId: string, xPaginationLimit?: number, xPaginationCurrentPage?: number, xPaginationSort?: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<Array<CustomIcmsConfByState>> {
         ...
         */
        public companiesCompanyIdIcmsStateGet (companyId: string, state: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<CustomIcmsConfByState> {
         ...
         */
        public createICMS (companyId: string, body: CustomIcmsConfByState, extraHttpRequestParams?: any ) : ng.IHttpPromise<InlineResponse201> {
            const localVarPath = this.basePath + '/companies/{companyId}/icms'
                .replace('{' + 'companyId' + '}', String(companyId));
         ...
         * @param state Brazilian State
         */
        public deleteCustomIcmsConfByState (companyId: string, state: string, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/companies/{companyId}/icms/{state}'
                .replace('{' + 'companyId' + '}', String(companyId))
                .replace('{' + 'state' + '}', String(state));
         ...
         * @param body Transaction Message
         */
        public updateCustomIcmsConfByState (companyId: string, state: string, body: CustomIcmsConfByState, extraHttpRequestParams?: any ) : ng.IHttpPromise<{}> {
            const localVarPath = this.basePath + '/companies/{companyId}/icms/{state}'
                .replace('{' + 'companyId' + '}', String(companyId))
                .replace('{' + 'state' + '}', String(state));
