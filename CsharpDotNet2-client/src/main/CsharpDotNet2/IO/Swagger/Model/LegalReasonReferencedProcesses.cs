...
namespace IO.Swagger.Model {
  ...
  public class LegalReasonReferencedProcesses {
    ...
    /// </summary>
    /// <value>Process Identifier (NFe <nProc> tag)</value>
    ...
    /// </summary>
    /// <value>Process Origin (NFe <indProc> tag) - '0' # SEFAZ; - '1' # Justiça Federal; - '2' # Justiça Estadual; - '3' # Secex/RFB; - '9' # Outros </value>
