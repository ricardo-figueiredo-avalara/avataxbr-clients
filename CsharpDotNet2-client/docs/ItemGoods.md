...
**IcmsBaseDiscountForMonoPhaseSocialContr** | **double?** | Discount allowed on icms base when PIS/COFINS are Monophase | [optional] [default to null]
...
**SalesUnitIPIfactor** | **double?** | factor to convert sales quantity to IPI taxable quantity when it is by SRF Statutory Retail Price (Pauta) | [optional] [default to null]
**SalesUnitIcmsfactor** | **double?** | factor to convert sales quantity to ICMS taxable quantity when it is by SRF Statutory Retail Price (Pauta) | [optional] [default to null]
**SalesUnitIcmsStfactor** | **double?** | factor to convert sales quantity to ICMS-ST taxable quantity when it is by SRF Statutory Retail Price (Pauta) | [optional] [default to null]
