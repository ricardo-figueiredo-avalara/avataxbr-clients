...
**IcmsRateForSimplestaxregime** | **double?** | Actual ICMS Rate for this company (if the company is Tax Regime Simplified). Aliquota de ICMS da companhia caso Optante do Simples  | [optional] [default to null]
...
**Configuration** | [**CompanyConfiguration**](CompanyConfiguration.md) |  | [optional] [default to null]
**MailServer** | [**CompanyMailServer**](CompanyMailServer.md) |  | [optional] [default to null]
**AuthorizedToDownloadNFe** | [**List&lt;CompanyAuthorizedToDownloadNFe&gt;**](CompanyAuthorizedToDownloadNFe.md) | Person or company authorized to downloadNFe | [optional] [default to null]
