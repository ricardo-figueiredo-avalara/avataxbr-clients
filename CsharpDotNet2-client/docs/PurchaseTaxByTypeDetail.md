# IO.Swagger.Model.PurchaseTaxByTypeDetail
## Properties
...
**SubtotalExempt** | **double?** | This decimal captures how much of the lineAmount was non-taxed. This is simply the line amount minus the taxable. | [optional] [default to null]
...
**SignificantLocations** | **List&lt;string&gt;** | This element captures the list of locations that contributed to the tax determination. for BR16 Service is Buyer and Seller Address | [optional] [default to null]
