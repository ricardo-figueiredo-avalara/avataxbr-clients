...
/**
 * PurchaseTaxByTypeDetail Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PurchaseTaxByTypeDetail implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PurchaseTaxByTypeDetail';
    ...
    /**
     * Sets tax_type
     * @param string $tax_type Tax identificator - 'pis' - 'pisRf' - 'cofins' - 'cofinsRf' - 'csll' - 'csllRf' - 'irrf' - 'inssAr' - 'inssRf' - 'issRf'
     * @return $this
     */
    public function setTaxType($tax_type)
    {
        $allowed_values = array('pis', 'pisRf', 'cofins', 'cofinsRf', 'csll', 'csllRf', 'irrf', 'inssAr', 'inssRf', 'issRf');
        if (!is_null($tax_type) && (!in_array($tax_type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'tax_type', must be one of 'pis', 'pisRf', 'cofins', 'cofinsRf', 'csll', 'csllRf', 'irrf', 'inssAr', 'inssRf', 'issRf'");
        }
