...
/**
 * EntityLocation Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EntityLocation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EntityLocation';
    ...
    public function setStreet($street)
    {
        if (!is_null($street) && (strlen($street) > 60)) {
            throw new \InvalidArgumentException('invalid length for $street when calling EntityLocation., must be smaller than or equal to 60.');
        }
    ...
    public function setNeighborhood($neighborhood)
    {
        if (!is_null($neighborhood) && (strlen($neighborhood) > 60)) {
            throw new \InvalidArgumentException('invalid length for $neighborhood when calling EntityLocation., must be smaller than or equal to 60.');
        }
    ...
    public function setZipcode($zipcode)
    {
        ...
        if ((!preg_match("/^(\\d{8}|\\d{5}\\-\\d{3})$/", $zipcode))) {
            throw new \InvalidArgumentException("invalid value for $zipcode when calling EntityLocation., must conform to the pattern /^(\\d{8}|\\d{5}\\-\\d{3})$/.");
        }
    ...
    public function setCityCode($city_code)
    {
        ...
        if (!is_null($city_code) && (!preg_match("/^(\\d{7})$/", $city_code))) {
            throw new \InvalidArgumentException("invalid value for $city_code when calling EntityLocation., must conform to the pattern /^(\\d{7})$/.");
        }
    ...
    public function setCityName($city_name)
    {
        if (!is_null($city_name) && (strlen($city_name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $city_name when calling EntityLocation., must be smaller than or equal to 60.');
        }
    ...
    public function setCountryCode($country_code)
    {
        ...
        if (!is_null($country_code) && (!preg_match("/[0-9]{1,4}/", $country_code))) {
            throw new \InvalidArgumentException("invalid value for $country_code when calling EntityLocation., must conform to the pattern /[0-9]{1,4}/.");
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling EntityLocation., must be smaller than or equal to 3.');
        }
        if (!is_null($country) && (!preg_match("/^([A-Z]{3})$/", $country))) {
            throw new \InvalidArgumentException("invalid value for $country when calling EntityLocation., must conform to the pattern /^([A-Z]{3})$/.");
        }
