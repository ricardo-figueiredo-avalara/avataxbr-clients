...
/**
 * IcmsConfByState Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class IcmsConfByState implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IcmsConfByState';
    ...
    {
        if ((strlen($code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $code when calling IcmsConfByState., must be smaller than or equal to 60.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $name when calling IcmsConfByState., must be smaller than or equal to 60.');
        }
    ...
    public function setMsrpUnit($msrp_unit)
    {
        if (!is_null($msrp_unit) && (strlen($msrp_unit) > 6)) {
            throw new \InvalidArgumentException('invalid length for $msrp_unit when calling IcmsConfByState., must be smaller than or equal to 6.');
        }
    ...
    public function setIcmsLegalReason($icms_legal_reason)
    {
        if (!is_null($icms_legal_reason) && (strlen($icms_legal_reason) > 60)) {
            throw new \InvalidArgumentException('invalid length for $icms_legal_reason when calling IcmsConfByState., must be smaller than or equal to 60.');
        }
