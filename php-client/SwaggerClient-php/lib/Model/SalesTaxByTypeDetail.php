...
/**
 * SalesTaxByTypeDetail Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SalesTaxByTypeDetail implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SalesTaxByTypeDetail';
    ...
    protected static $setters = [
        ...
        'subtotal_exempt' => 'setSubtotalExempt',
        'rate' => 'setRate',
        'tax' => 'setTax',
    ...
    protected static $getters = [
        ...
        'subtotal_exempt' => 'getSubtotalExempt',
        'rate' => 'getRate',
        'tax' => 'getTax',
    ...
    const TAX_TYPE_PIS_RF = 'pisRf';
    const TAX_TYPE_COFINS = 'cofins';
    const TAX_TYPE_COFINS_RF = 'cofinsRf';
    const TAX_TYPE_CSLL = 'csll';
    const TAX_TYPE_CSLL_RF = 'csllRf';
    const TAX_TYPE_IRRF = 'irrf';
    const TAX_TYPE_INSS = 'inss';
    const TAX_TYPE_INSS_RF = 'inssRf';
    const TAX_TYPE_ISS = 'iss';
    const TAX_TYPE_ISS_RF = 'issRf';
    ...
    {
        return [
            self::TAX_TYPE_APROXTRIB_CITY,
            self::TAX_TYPE_APROXTRIB_FED,
            self::TAX_TYPE_PIS,
            self::TAX_TYPE_PIS_RF,
            self::TAX_TYPE_COFINS,
            self::TAX_TYPE_COFINS_RF,
            self::TAX_TYPE_CSLL,
            self::TAX_TYPE_CSLL_RF,
            self::TAX_TYPE_IRRF,
            self::TAX_TYPE_INSS,
            self::TAX_TYPE_INSS_RF,
            self::TAX_TYPE_ISS,
            self::TAX_TYPE_ISS_RF,
            self::TAX_TYPE_IRPJ,
        ];
    }
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['subtotal_exempt'] = isset($data['subtotal_exempt']) ? $data['subtotal_exempt'] : null;
    ...
    /**
     * Sets tax_type
     * @param string $tax_type Tax identificator - 'aproxtribCity' - 'aproxtribFed' - 'pis' - 'pisRf' - 'cofins' - 'cofinsRf' - 'csll' - 'csllRf' - 'irrf' - 'inss' - 'inssRf' - 'iss' - 'issRf' - 'irpj'
     * @return $this
     */
    public function setTaxType($tax_type)
    {
        $allowed_values = array('aproxtribCity', 'aproxtribFed', 'pis', 'pisRf', 'cofins', 'cofinsRf', 'csll', 'csllRf', 'irrf', 'inss', 'inssRf', 'iss', 'issRf', 'irpj');
        if (!is_null($tax_type) && (!in_array($tax_type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'tax_type', must be one of 'aproxtribCity', 'aproxtribFed', 'pis', 'pisRf', 'cofins', 'cofinsRf', 'csll', 'csllRf', 'irrf', 'inss', 'inssRf', 'iss', 'issRf', 'irpj'");
        }
    ...
    /**
     * Gets subtotal_exempt
     * @return double
     */
    public function getSubtotalExempt()
    {
        return $this->container['subtotal_exempt'];
    }

    /**
     * Sets subtotal_exempt
     * @param double $subtotal_exempt This decimal captures how much of the lineAmount was non-taxed. This is simply the line amount minus the taxable.
     * @return $this
     */
    public function setSubtotalExempt($subtotal_exempt)
    {
        $this->container['subtotal_exempt'] = $subtotal_exempt;
     ...
     * @param string[] $significant_locations This element captures the list of locations that contributed to the tax determination. for BR16 Service is Buyer and Seller Address
     * @return $this
     */
    ...
    /**
     * Sets tax_rule_type
     * @param string $tax_rule_type This string with type of rule - 'SELLER' - 'BUYER' - 'TRANSACTION' - 'ITEM' - 'TAX'
     * @return $this
     */
