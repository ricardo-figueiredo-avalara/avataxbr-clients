...
/**
 * LineForSefazGoods Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LineForSefazGoods implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LineForSefazGoods';
    ...
    protected static $swaggerTypes = [
        ...
        'extend' => '\Swagger\Client\Model\AgastExtendForSefaz'
    ];
    ...
    public function setItemCode($item_code)
    {
        if ((strlen($item_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $item_code when calling LineForSefazGoods., must be smaller than or equal to 60.');
        }
    ...
    public function setProcessScenario($process_scenario)
    {
        if ((strlen($process_scenario) > 60)) {
            throw new \InvalidArgumentException('invalid length for $process_scenario when calling LineForSefazGoods., must be smaller than or equal to 60.');
        }
    ...
    public function setOrderNumber($order_number)
    {
        if (!is_null($order_number) && (strlen($order_number) > 15)) {
            throw new \InvalidArgumentException('invalid length for $order_number when calling LineForSefazGoods., must be smaller than or equal to 15.');
        }
        if (!is_null($order_number) && (strlen($order_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $order_number when calling LineForSefazGoods., must be bigger than or equal to 1.');
        }
    ...
    public function setOrderItemNumber($order_item_number)
    {
        ...
        if (!is_null($order_item_number) && (!preg_match("/[0-9]{1,6}/", $order_item_number))) {
            throw new \InvalidArgumentException("invalid value for $order_item_number when calling LineForSefazGoods., must conform to the pattern /[0-9]{1,6}/.");
        }
    ...
    public function setFciNumber($fci_number)
    {
        ...
        if (!is_null($fci_number) && (!preg_match("/[A-F0-9]{8}-[A-F0-9]{4}-[A-F0-9]{4}-[A-F0-9]{4}-[A-F0-9]{12}/", $fci_number))) {
            throw new \InvalidArgumentException("invalid value for $fci_number when calling LineForSefazGoods., must conform to the pattern /[A-F0-9]{8}-[A-F0-9]{4}-[A-F0-9]{4}-[A-F0-9]{4}-[A-F0-9]{12}/.");
        }
    ...
    public function setRecopiNumber($recopi_number)
    {
        if (!is_null($recopi_number) && (strlen($recopi_number) > 20)) {
            throw new \InvalidArgumentException('invalid length for $recopi_number when calling LineForSefazGoods., must be smaller than or equal to 20.');
        }
        if (!is_null($recopi_number) && (!preg_match("/[0-9]{20}/", $recopi_number))) {
            throw new \InvalidArgumentException("invalid value for $recopi_number when calling LineForSefazGoods., must conform to the pattern /[0-9]{20}/.");
        }
    ...
    public function setInfAdProd($inf_ad_prod)
    {
        if (!is_null($inf_ad_prod) && (strlen($inf_ad_prod) > 500)) {
            throw new \InvalidArgumentException('invalid length for $inf_ad_prod when calling LineForSefazGoods., must be smaller than or equal to 500.');
        }
    ...
    /**
     * Gets extend
     * @return \Swagger\Client\Model\AgastExtendForSefaz
     */
    ...
    /**
     * Sets extend
     * @param \Swagger\Client\Model\AgastExtendForSefaz $extend
     * @return $this
     */
