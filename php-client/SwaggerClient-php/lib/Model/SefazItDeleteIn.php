...
/**
 * SefazItDeleteIn Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SefazItDeleteIn implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SefazItDeleteIn';
    ...
    public function setMessage($message)
    {
        if (!is_null($message) && (strlen($message) > 255)) {
            throw new \InvalidArgumentException('invalid length for $message when calling SefazItDeleteIn., must be smaller than or equal to 255.');
        }
        if (!is_null($message) && (strlen($message) < 15)) {
            throw new \InvalidArgumentException('invalid length for $message when calling SefazItDeleteIn., must be bigger than or equal to 15.');
        }
