...
/**
 * CustomProcessScenario Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CustomProcessScenario implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomProcessScenario';
    ...
    {
        if ((strlen($code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CustomProcessScenario., must be smaller than or equal to 60.');
        }
    ...
    public function setPisExemptLegalReasonCode($pis_exempt_legal_reason_code)
    {
        if (!is_null($pis_exempt_legal_reason_code) && (strlen($pis_exempt_legal_reason_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $pis_exempt_legal_reason_code when calling CustomProcessScenario., must be smaller than or equal to 3.');
        }
    ...
    public function setPisExemptLegalReason($pis_exempt_legal_reason)
    {
        if (!is_null($pis_exempt_legal_reason) && (strlen($pis_exempt_legal_reason) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $pis_exempt_legal_reason when calling CustomProcessScenario., must be smaller than or equal to 1024.');
        }
    ...
    public function setCofinsExemptLegalReasonCode($cofins_exempt_legal_reason_code)
    {
        if (!is_null($cofins_exempt_legal_reason_code) && (strlen($cofins_exempt_legal_reason_code) > 3)) {
            throw new \InvalidArgumentException('invalid length for $cofins_exempt_legal_reason_code when calling CustomProcessScenario., must be smaller than or equal to 3.');
        }
    ...
    public function setCofinsExemptLegalReason($cofins_exempt_legal_reason)
    {
        if (!is_null($cofins_exempt_legal_reason) && (strlen($cofins_exempt_legal_reason) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $cofins_exempt_legal_reason when calling CustomProcessScenario., must be smaller than or equal to 1024.');
        }
    ...
    {
        if ((strlen($name) > 60)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CustomProcessScenario., must be smaller than or equal to 60.');
        }
