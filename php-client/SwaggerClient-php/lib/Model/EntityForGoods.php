...
/**
 * EntityForGoods Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class EntityForGoods implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EntityForGoods';
    ...
    public function setFederalTaxId($federal_tax_id)
    {
        ...
        if ((!preg_match("/([!-ÿ]{0}|[!-ÿ]{5,20})?/", $federal_tax_id))) {
            throw new \InvalidArgumentException("invalid value for $federal_tax_id when calling EntityForGoods., must conform to the pattern /([!-ÿ]{0}|[!-ÿ]{5,20})?/.");
        }
    ...
    public function setCityTaxId($city_tax_id)
    {
        if (!is_null($city_tax_id) && (strlen($city_tax_id) > 15)) {
            throw new \InvalidArgumentException('invalid length for $city_tax_id when calling EntityForGoods., must be smaller than or equal to 15.');
        }
    ...
    public function setStateTaxId($state_tax_id)
    {
        ...
        if (!is_null($state_tax_id) && (!preg_match("/[0-9]{2,14}|ISENTO/", $state_tax_id))) {
            throw new \InvalidArgumentException("invalid value for $state_tax_id when calling EntityForGoods., must conform to the pattern /[0-9]{2,14}|ISENTO/.");
        }
    ...
    public function setSuframa($suframa)
    {
        ...
        if (!is_null($suframa) && (!preg_match("/[0-9]{8,9}/", $suframa))) {
            throw new \InvalidArgumentException("invalid value for $suframa when calling EntityForGoods., must conform to the pattern /[0-9]{8,9}/.");
        }
    ...
    public function setPhone($phone)
    {
        ...
        if (!is_null($phone) && (!preg_match("/[0-9]{6,14}/", $phone))) {
            throw new \InvalidArgumentException("invalid value for $phone when calling EntityForGoods., must conform to the pattern /[0-9]{6,14}/.");
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (strlen($email) > 60)) {
            throw new \InvalidArgumentException('invalid length for $email when calling EntityForGoods., must be smaller than or equal to 60.');
        }
    ...
    /**
     * Sets icms_tax_payer
     * @param bool $icms_tax_payer Inform if the entity is ICMS tax payer.
     * @return $this
     */
