 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CustomAgast implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CustomAgast';
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (strlen($description) > 200)) {
            throw new \InvalidArgumentException('invalid length for $description when calling CustomAgast., must be smaller than or equal to 200.');
        }
    ...
    public function setHsCode($hs_code)
    {
        if (!is_null($hs_code) && (strlen($hs_code) > 8)) {
            throw new \InvalidArgumentException('invalid length for $hs_code when calling CustomAgast., must be smaller than or equal to 8.');
        }
    ...
    public function setCest($cest)
    {
        ...
        if (!is_null($cest) && (!preg_match("/[0-9]{7}/", $cest))) {
            throw new \InvalidArgumentException("invalid value for $cest when calling CustomAgast., must conform to the pattern /[0-9]{7}/.");
        }
    ...
    public function setCean($cean)
    {
        ...
        if (!is_null($cean) && (!preg_match("/[0-9]{0}|[0-9]{8}|[0-9]{12,14}/", $cean))) {
            throw new \InvalidArgumentException("invalid value for $cean when calling CustomAgast., must conform to the pattern /[0-9]{0}|[0-9]{8}|[0-9]{12,14}/.");
        }
    ...
    public function setPisExemptLegalReason($pis_exempt_legal_reason)
    {
        if (!is_null($pis_exempt_legal_reason) && (strlen($pis_exempt_legal_reason) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $pis_exempt_legal_reason when calling CustomAgast., must be smaller than or equal to 1024.');
        }
    ...
    public function setCofinsExemptLegalReason($cofins_exempt_legal_reason)
    {
        if (!is_null($cofins_exempt_legal_reason) && (strlen($cofins_exempt_legal_reason) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $cofins_exempt_legal_reason when calling CustomAgast., must be smaller than or equal to 1024.');
        }
    ...
    public function setCsllExemptLegalReason($csll_exempt_legal_reason)
    {
        if (!is_null($csll_exempt_legal_reason) && (strlen($csll_exempt_legal_reason) > 1024)) {
            throw new \InvalidArgumentException('invalid length for $csll_exempt_legal_reason when calling CustomAgast., must be smaller than or equal to 1024.');
        }
