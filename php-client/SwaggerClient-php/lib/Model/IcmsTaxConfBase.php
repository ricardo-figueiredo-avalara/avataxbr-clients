...
/**
 * IcmsTaxConfBase Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class IcmsTaxConfBase implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IcmsTaxConfBase';
    ...
    public function setMessageCode($message_code)
    {
        if (!is_null($message_code) && (strlen($message_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $message_code when calling IcmsTaxConfBase., must be smaller than or equal to 60.');
        }
