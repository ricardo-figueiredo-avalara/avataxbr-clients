...
/**
 * LegalReasonReferencedProcesses Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LegalReasonReferencedProcesses implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LegalReason_referencedProcesses';
    ...
    /**
     * Sets n_proc
     * @param string $n_proc Process Identifier (NFe <nProc> tag)
     * @return $this
     */
    public function setNProc($n_proc)
    {
        if (!is_null($n_proc) && (strlen($n_proc) > 60)) {
            throw new \InvalidArgumentException('invalid length for $n_proc when calling LegalReasonReferencedProcesses., must be smaller than or equal to 60.');
        }
    ...
    /**
     * Sets ind_proc
     * @param string $ind_proc Process Origin (NFe <indProc> tag) - '0' # SEFAZ; - '1' # Justiça Federal; - '2' # Justiça Estadual; - '3' # Secex/RFB; - '9' # Outros
     * @return $this
     */
