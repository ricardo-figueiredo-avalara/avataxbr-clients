...
/**
 * HeaderBaseInfo Class Doc Comment
 *
 * @category    Class */
/**
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class HeaderBaseInfo implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'HeaderBaseInfo';
    ...
    public function setCompanyCode($company_code)
    {
        if ((strlen($company_code) > 60)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling HeaderBaseInfo., must be smaller than or equal to 60.');
        }
    ...
    public function setCompanyLocation($company_location)
    {
        if ((strlen($company_location) > 64)) {
            throw new \InvalidArgumentException('invalid length for $company_location when calling HeaderBaseInfo., must be smaller than or equal to 64.');
        }
