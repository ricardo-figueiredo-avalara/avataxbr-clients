...
export interface TaxTypeRateWithholding {
    all?: models.WithholdDef;

    business?: models.WithholdDef;

    federalGovernment?: models.WithholdDef;

    stateGovernment?: models.WithholdDef;

    cityGovernment?: models.WithholdDef;
