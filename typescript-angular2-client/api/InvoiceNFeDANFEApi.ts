...
export class InvoiceNFeDANFEApi {
     ...
     */
    public nfePrint(authorization: string, key: string, extraHttpRequestParams?: any): Observable<any> {
        return this.nfePrintWithHttpInfo(authorization, key, extraHttpRequestParams)
     ...
     * @param key Invoice Key
     */
    public nfePrintWithHttpInfo(authorization: string, key: string, extraHttpRequestParams?: any): Observable<Response> {
        const path = this.basePath + `/invoices/nfe/${key}`;
