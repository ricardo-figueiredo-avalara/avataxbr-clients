...
type PurchaseHeaderOut struct {
	...
	Entity PurchaseEntity `json:"entity,omitempty"`

	Payment PurchaseHeaderOutPayment `json:"payment,omitempty"`

	TaxesConfig PurchaseTaxesConfig `json:"taxesConfig,omitempty"`

	DefaultLocations PurchaseDefaultLocations `json:"defaultLocations,omitempty"`
}
