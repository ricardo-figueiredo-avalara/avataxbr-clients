...
type SalesHeaderOut struct {
	...
	Payment SalesHeaderOutPayment `json:"payment,omitempty"`
	...
	DiscriminationOut string `json:"discriminationOut,omitempty"`
	...
	EdiSyncState string `json:"ediSyncState,omitempty"`
}
