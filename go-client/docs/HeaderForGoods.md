...
**Participants** | [**HeaderForGoodsParticipants**](HeaderForGoods_participants.md) |  | [optional] [default to null]
...
**EntityCode** | **string** | This string is a code maintained by the client application and recorded in CUP to uniquely identify the party with whom the company (identified by companyCode) is transacting. It is unique within the context of a Company. | [optional] [default to null]
**Currency** | **string** | currency code | [optional] [default to null]
...
**TransactionDate** | **string** | This string is the transaction date in ISO 8601 format, create transaction date | [optional] [default to null]
