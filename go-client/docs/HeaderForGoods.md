...
**InvoiceNumber** | **int32** | Invoice number, sequential unique by invoice serial (Número da nota fiscal) | [default to null]
**InvoiceSerial** | **int32** | Invoice number, sequential unique by invoice serial (Número da nota fiscal)  | [default to null]
