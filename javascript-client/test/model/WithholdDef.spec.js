...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Br16Api.WithholdDef();
  });
  ...
  describe('WithholdDef', function() {
    it('should create an instance of WithholdDef', function() {
      // uncomment below and update the code to test WithholdDef
      //var instane = new Br16Api.WithholdDef();
      //expect(instance).to.be.a(Br16Api.WithholdDef);
    });
