...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Br16Api.PurchaseCalculatedTaxSummaryForServiceTaxByType();
  });
  ...
  describe('PurchaseCalculatedTaxSummaryForServiceTaxByType', function() {
    it('should create an instance of PurchaseCalculatedTaxSummaryForServiceTaxByType', function() {
      ...
      //var instane = new Br16Api.PurchaseCalculatedTaxSummaryForServiceTaxByType();
      //expect(instance).to.be.a(Br16Api.PurchaseCalculatedTaxSummaryForServiceTaxByType);
    });
