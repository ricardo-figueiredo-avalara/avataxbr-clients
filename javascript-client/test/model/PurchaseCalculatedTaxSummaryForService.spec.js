...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.PurchaseCalculatedTaxSummaryForService();
  });
  ...
  describe('PurchaseCalculatedTaxSummaryForService', function() {
    it('should create an instance of PurchaseCalculatedTaxSummaryForService', function() {
      // uncomment below and update the code to test PurchaseCalculatedTaxSummaryForService
      //var instane = new AvaTaxBrazil.PurchaseCalculatedTaxSummaryForService();
      //expect(instance).to.be.a(AvaTaxBrazil.PurchaseCalculatedTaxSummaryForService);
    });
