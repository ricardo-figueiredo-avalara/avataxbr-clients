...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Br16Api.PurchaseCalculatedTaxSummaryForService();
  });
  ...
  describe('PurchaseCalculatedTaxSummaryForService', function() {
    it('should create an instance of PurchaseCalculatedTaxSummaryForService', function() {
      ...
      //var instane = new Br16Api.PurchaseCalculatedTaxSummaryForService();
      //expect(instance).to.be.a(Br16Api.PurchaseCalculatedTaxSummaryForService);
    });
