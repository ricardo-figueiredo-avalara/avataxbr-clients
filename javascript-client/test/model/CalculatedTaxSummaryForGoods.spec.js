...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.CalculatedTaxSummaryForGoods();
  });
  ...
  describe('CalculatedTaxSummaryForGoods', function() {
    it('should create an instance of CalculatedTaxSummaryForGoods', function() {
      // uncomment below and update the code to test CalculatedTaxSummaryForGoods
      //var instane = new AvaTaxBrazil.CalculatedTaxSummaryForGoods();
      //expect(instance).to.be.a(AvaTaxBrazil.CalculatedTaxSummaryForGoods);
    });
    ...
    it('should have the property taxedDiscount (base name: "taxedDiscount")', function() {
      // uncomment below and update the code to test the property taxedDiscount
      //var instane = new AvaTaxBrazil.CalculatedTaxSummaryForGoods();
      //expect(instance).to.be();
    });

    it('should have the property untaxedDiscount (base name: "untaxedDiscount")', function() {
      // uncomment below and update the code to test the property untaxedDiscount
      //var instane = new AvaTaxBrazil.CalculatedTaxSummaryForGoods();
      //expect(instance).to.be();
    });
