...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Br16Api.CalculatedTaxSummaryForGoods();
  });
  ...
  describe('CalculatedTaxSummaryForGoods', function() {
    it('should create an instance of CalculatedTaxSummaryForGoods', function() {
      ...
      //var instane = new Br16Api.CalculatedTaxSummaryForGoods();
      //expect(instance).to.be.a(Br16Api.CalculatedTaxSummaryForGoods);
    });
