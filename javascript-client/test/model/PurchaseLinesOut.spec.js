...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.PurchaseLinesOut();
  });
  ...
  describe('PurchaseLinesOut', function() {
    it('should create an instance of PurchaseLinesOut', function() {
      // uncomment below and update the code to test PurchaseLinesOut
      //var instane = new AvaTaxBrazil.PurchaseLinesOut();
      //expect(instance).to.be.a(AvaTaxBrazil.PurchaseLinesOut);
    });
