...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.PaymentTaxByType();
  });
  ...
  describe('PaymentTaxByType', function() {
    it('should create an instance of PaymentTaxByType', function() {
      // uncomment below and update the code to test PaymentTaxByType
      //var instane = new AvaTaxBrazil.PaymentTaxByType();
      //expect(instance).to.be.a(AvaTaxBrazil.PaymentTaxByType);
    });
