...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.CalculatedTaxSummaryForGoodsTaxByType();
  });
  ...
  describe('CalculatedTaxSummaryForGoodsTaxByType', function() {
    it('should create an instance of CalculatedTaxSummaryForGoodsTaxByType', function() {
      ...
      //var instane = new AvaTaxBrazil.CalculatedTaxSummaryForGoodsTaxByType();
      //expect(instance).to.be.a(AvaTaxBrazil.CalculatedTaxSummaryForGoodsTaxByType);
    });
