...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Br16Api.IcmsConfByStateIcmsSTConf();
  });
  ...
  describe('IcmsConfByStateIcmsSTConf', function() {
    it('should create an instance of IcmsConfByStateIcmsSTConf', function() {
      ...
      //var instane = new Br16Api.IcmsConfByStateIcmsSTConf();
      //expect(instance).to.be.a(Br16Api.IcmsConfByStateIcmsSTConf);
    });
