...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.IcmsConfByStateIcmsSTConf();
  });
  ...
  describe('IcmsConfByStateIcmsSTConf', function() {
    it('should create an instance of IcmsConfByStateIcmsSTConf', function() {
      // uncomment below and update the code to test IcmsConfByStateIcmsSTConf
      //var instane = new AvaTaxBrazil.IcmsConfByStateIcmsSTConf();
      //expect(instance).to.be.a(AvaTaxBrazil.IcmsConfByStateIcmsSTConf);
    });
