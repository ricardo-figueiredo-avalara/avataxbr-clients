...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Br16Api.TaxByTypeSummaryJurisdiction();
  });
  ...
  describe('TaxByTypeSummaryJurisdiction', function() {
    it('should create an instance of TaxByTypeSummaryJurisdiction', function() {
      ...
      //var instane = new Br16Api.TaxByTypeSummaryJurisdiction();
      //expect(instance).to.be.a(Br16Api.TaxByTypeSummaryJurisdiction);
    });
