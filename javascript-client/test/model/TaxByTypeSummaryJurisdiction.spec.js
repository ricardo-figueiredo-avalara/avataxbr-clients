...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.TaxByTypeSummaryJurisdiction();
  });
  ...
  describe('TaxByTypeSummaryJurisdiction', function() {
    it('should create an instance of TaxByTypeSummaryJurisdiction', function() {
      // uncomment below and update the code to test TaxByTypeSummaryJurisdiction
      //var instane = new AvaTaxBrazil.TaxByTypeSummaryJurisdiction();
      //expect(instance).to.be.a(AvaTaxBrazil.TaxByTypeSummaryJurisdiction);
    });
