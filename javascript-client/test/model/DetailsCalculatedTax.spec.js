...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.DetailsCalculatedTax();
  });
  ...
  describe('DetailsCalculatedTax', function() {
    it('should create an instance of DetailsCalculatedTax', function() {
      // uncomment below and update the code to test DetailsCalculatedTax
      //var instane = new AvaTaxBrazil.DetailsCalculatedTax();
      //expect(instance).to.be.a(AvaTaxBrazil.DetailsCalculatedTax);
    });
