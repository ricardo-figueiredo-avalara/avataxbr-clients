...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.InlineResponse2003();
  });
  ...
  describe('InlineResponse2003', function() {
    it('should create an instance of InlineResponse2003', function() {
      ...
      //var instane = new AvaTaxBrazil.InlineResponse2003();
      //expect(instance).to.be.a(AvaTaxBrazil.InlineResponse2003);
    });

    it('should have the property contingency (base name: "contingency")', function() {
      // uncomment below and update the code to test the property contingency
      //var instane = new AvaTaxBrazil.InlineResponse2003();
