...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.SalesTaxByTypeDetail();
  });
  ...
  describe('SalesTaxByTypeDetail', function() {
    it('should create an instance of SalesTaxByTypeDetail', function() {
      // uncomment below and update the code to test SalesTaxByTypeDetail
      //var instane = new AvaTaxBrazil.SalesTaxByTypeDetail();
      //expect(instance).to.be.a(AvaTaxBrazil.SalesTaxByTypeDetail);
    });
