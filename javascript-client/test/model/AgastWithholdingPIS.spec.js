...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.AgastWithholdingPIS();
  });
  ...
  describe('AgastWithholdingPIS', function() {
    it('should create an instance of AgastWithholdingPIS', function() {
      // uncomment below and update the code to test AgastWithholdingPIS
      //var instane = new AvaTaxBrazil.AgastWithholdingPIS();
      //expect(instance).to.be.a(AvaTaxBrazil.AgastWithholdingPIS);
    });
