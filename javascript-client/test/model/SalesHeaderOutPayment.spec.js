...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.SalesHeaderOutPayment();
  });
  ...
  describe('SalesHeaderOutPayment', function() {
    it('should create an instance of SalesHeaderOutPayment', function() {
      // uncomment below and update the code to test SalesHeaderOutPayment
      //var instane = new AvaTaxBrazil.SalesHeaderOutPayment();
      //expect(instance).to.be.a(AvaTaxBrazil.SalesHeaderOutPayment);
    });
