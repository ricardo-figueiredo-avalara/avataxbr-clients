...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.PurchaseLinesIn();
  });
  ...
  describe('PurchaseLinesIn', function() {
    it('should create an instance of PurchaseLinesIn', function() {
      // uncomment below and update the code to test PurchaseLinesIn
      //var instane = new AvaTaxBrazil.PurchaseLinesIn();
      //expect(instance).to.be.a(AvaTaxBrazil.PurchaseLinesIn);
    });
