...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.ExportInfo();
  });
  ...
  describe('ExportInfo', function() {
    it('should create an instance of ExportInfo', function() {
      ...
      //var instane = new AvaTaxBrazil.ExportInfo();
      //expect(instance).to.be.a(AvaTaxBrazil.ExportInfo);
    });
    ...
    it('should have the property placeDescription (base name: "placeDescription")', function() {
      // uncomment below and update the code to test the property placeDescription
      //var instane = new AvaTaxBrazil.ExportInfo();
      //expect(instance).to.be();
    });
