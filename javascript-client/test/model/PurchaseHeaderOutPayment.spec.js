...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.PurchaseHeaderOutPayment();
  });
  ...
  describe('PurchaseHeaderOutPayment', function() {
    it('should create an instance of PurchaseHeaderOutPayment', function() {
      // uncomment below and update the code to test PurchaseHeaderOutPayment
      //var instane = new AvaTaxBrazil.PurchaseHeaderOutPayment();
      //expect(instance).to.be.a(AvaTaxBrazil.PurchaseHeaderOutPayment);
    });
