...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new AvaTaxBrazil.TaxByTypeSummaryJurisdictionForGoods();
  });
  ...
  describe('TaxByTypeSummaryJurisdictionForGoods', function() {
    it('should create an instance of TaxByTypeSummaryJurisdictionForGoods', function() {
      // uncomment below and update the code to test TaxByTypeSummaryJurisdictionForGoods
      //var instane = new AvaTaxBrazil.TaxByTypeSummaryJurisdictionForGoods();
      //expect(instance).to.be.a(AvaTaxBrazil.TaxByTypeSummaryJurisdictionForGoods);
    });
