...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Br16Api.TaxByTypeSummaryJurisdictionForGoods();
  });
  ...
  describe('TaxByTypeSummaryJurisdictionForGoods', function() {
    it('should create an instance of TaxByTypeSummaryJurisdictionForGoods', function() {
      ...
      //var instane = new Br16Api.TaxByTypeSummaryJurisdictionForGoods();
      //expect(instance).to.be.a(Br16Api.TaxByTypeSummaryJurisdictionForGoods);
    });
