...
(function(root, factory) {
  ...
  describe('CompanyLocationApi', function() {
    ...
    describe('getCompanyLocation', function() {
      it('should call getCompanyLocation successfully', function(done) {
        //uncomment below and update the code to test getCompanyLocation
        //instance.getCompanyLocation(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getCompanyLocationsList', function() {
      it('should call getCompanyLocationsList successfully', function(done) {
        //uncomment below and update the code to test getCompanyLocationsList
        //instance.getCompanyLocationsList(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
