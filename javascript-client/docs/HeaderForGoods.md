# Br16Api.HeaderForGoods

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**messageType** | **String** |  | [optional] [default to &#39;goods&#39;]
...
**eDocCreatorPerspective** | **Boolean** | This Flag is used only when eDocCreatorType is other and the return show Taxes using eDocCreator perspective or self perspective. | [optional] [default to true]
...
**invoiceNumber** | **Number** | Invoice number, sequential unique by invoice serial (Número da nota fiscal) | 
**invoiceSerial** | **Number** | Invoice number, sequential unique by invoice serial (Número da nota fiscal)  | 
