...
**icmsRateForSimplestaxregime** | **Number** | Actual ICMS Rate for this company (if the company is Tax Regime Simplified). Aliquota de ICMS da companhia caso Optante do Simples  | [optional] 
...
**authorizedToDownloadNFe** | [**[CompanyAuthorizedToDownloadNFe]**](CompanyAuthorizedToDownloadNFe.md) | Person or company authorized to downloadNFe | [optional] 
