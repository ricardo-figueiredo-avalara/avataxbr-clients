...
(function(factory) {
   ...
   * <pre>
   * var xxxSvc = new AvaTaxBrazil.XxxApi(); // Allocate the API class we're going to use.
   * var yyy = new AvaTaxBrazil.Yyy(); // Construct a model instance.
   * yyyModel.someProperty = 'someValue';
   * ...
   * var zzz = xxxSvc.doSomething(yyyModel); // Invoke the service.
   * ...
  ...
  var exports = {
    ...
    ApiClient: ApiClient,
    /**
     * The AbrasfItDeleteIn model constructor.
     * @property {module:model/AbrasfItDeleteIn}
     */
    AbrasfItDeleteIn: AbrasfItDeleteIn,
    /**
     * The AbrasfItGetOut model constructor.
     * @property {module:model/AbrasfItGetOut}
     */
    AbrasfItGetOut: AbrasfItGetOut,
    /**
     * The AbrasfPostOut model constructor.
     * @property {module:model/AbrasfPostOut}
     */
    AbrasfPostOut: AbrasfPostOut,
    /**
    ...
    /**
     * The AgastWithholding model constructor.
     * @property {module:model/AgastWithholding}
     */
    AgastWithholding: AgastWithholding,
    /**
     * The AgastWithholdingCOFINS model constructor.
     * @property {module:model/AgastWithholdingCOFINS}
     */
    AgastWithholdingCOFINS: AgastWithholdingCOFINS,
    /**
     * The AgastWithholdingCSLL model constructor.
     * @property {module:model/AgastWithholdingCSLL}
     */
    AgastWithholdingCSLL: AgastWithholdingCSLL,
    /**
     * The AgastWithholdingPIS model constructor.
     * @property {module:model/AgastWithholdingPIS}
     */
    AgastWithholdingPIS: AgastWithholdingPIS,
    /**
    ...
    /**
     * The CsvIbptList model constructor.
     * @property {module:model/CsvIbptList}
     */
    CsvIbptList: CsvIbptList,
    /**
    ...
    /**
     * The ICMSSesonReason model constructor.
     * @property {module:model/ICMSSesonReason}
     */
    ...
    /**
     * The TransactionForAbrasf model constructor.
     * @property {module:model/TransactionForAbrasf}
     */
    TransactionForAbrasf: TransactionForAbrasf,
    /**
     * The TransactionForAbrasfList model constructor.
     * @property {module:model/TransactionForAbrasfList}
     */
    TransactionForAbrasfList: TransactionForAbrasfList,
    /**
    ...
    /**
     * The GooodsCalculationsApi service constructor.
     * @property {module:api/GooodsCalculationsApi}
     */
    GooodsCalculationsApi: GooodsCalculationsApi,
    /**
