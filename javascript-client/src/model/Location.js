...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AvaTaxBrazil.Location = factory(root.AvaTaxBrazil.ApiClient, root.AvaTaxBrazil.Address, root.AvaTaxBrazil.LocationSecondaryStateTaxId, root.AvaTaxBrazil.StateEnum);
  }
   ...
   */
  var exports = function(zipcode, cityCode, state, companyId, code, type) {
    var _this = this;

    Address.call(_this, zipcode, cityCode, state);
