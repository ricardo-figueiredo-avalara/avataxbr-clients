...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AvaTaxBrazil.AgastWithholdingCOFINS = factory(root.AvaTaxBrazil.ApiClient);
  }
  ...
  /**
   * The AgastWithholdingCOFINS model module.
   * @module model/AgastWithholdingCOFINS
   * @version 1.0
   */

  /**
   * Constructs a new <code>AgastWithholdingCOFINS</code>.
   * inform if this item is subject to withholding COFINS on service Transactions, by entity type, default true
   * @alias module:model/AgastWithholdingCOFINS
   * @class
   */
  ...
  /**
   * Constructs a <code>AgastWithholdingCOFINS</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AgastWithholdingCOFINS} obj Optional instance to populate.
   * @return {module:model/AgastWithholdingCOFINS} The populated <code>AgastWithholdingCOFINS</code> instance.
   */
