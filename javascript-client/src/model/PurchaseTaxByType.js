...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AvaTaxBrazil.PurchaseTaxByType = factory(root.AvaTaxBrazil.ApiClient, root.AvaTaxBrazil.TaxByTypeTax);
  }
  ...
  /**
   * The PurchaseTaxByType model module.
   * @module model/PurchaseTaxByType
   * @version 1.0
   */

  /**
   * Constructs a new <code>PurchaseTaxByType</code>.
   * Object with summary of all taxes returned by engine
   * @alias module:model/PurchaseTaxByType
   * @class
   */
  ...
  /**
   * Constructs a <code>PurchaseTaxByType</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PurchaseTaxByType} obj Optional instance to populate.
   * @return {module:model/PurchaseTaxByType} The populated <code>PurchaseTaxByType</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('inssAr')) {
        obj['inssAr'] = TaxByTypeTax.constructFromObject(data['inssAr']);
      }
  ...
  /**
   * @member {module:model/TaxByTypeTax} inssAr
   */
