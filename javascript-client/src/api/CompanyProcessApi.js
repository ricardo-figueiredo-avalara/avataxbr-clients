...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AvaTaxBrazil.CompanyProcessApi = factory(root.AvaTaxBrazil.ApiClient, root.AvaTaxBrazil.CustomProcessScenario, root.AvaTaxBrazil.InlineResponse201, root.AvaTaxBrazil.Message, root.AvaTaxBrazil.ValidationError);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.createCustomProcessScenario = function(authorization, companyId, body, opts, callback) {
      opts = opts || {};
      var postBody = body;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling createCustomProcessScenario");
      }
     ...
     */
    this.deleteCustomProcessScenario = function(authorization, companyId, code, callback) {
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling deleteCustomProcessScenario");
      }
    ...
    /**
     * Callback function to receive the result of the getCompanyProcess operation.
     * @callback module:api/CompanyProcessApi~getCompanyProcessCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} companyId Company ID
     * @param {String} code Process Code
     * @param {module:api/CompanyProcessApi~getCompanyProcessCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/CustomProcessScenario}
     */
    this.getCompanyProcess = function(authorization, companyId, code, callback) {
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling getCompanyProcess");
      }

      // verify the required parameter 'companyId' is set
      if (companyId == undefined || companyId == null) {
        throw new Error("Missing the required parameter 'companyId' when calling getCompanyProcess");
      }

      // verify the required parameter 'code' is set
      if (code == undefined || code == null) {
        throw new Error("Missing the required parameter 'code' when calling getCompanyProcess");
      }
    ...
    /**
     * Callback function to receive the result of the getCompanyProcessList operation.
     * @callback module:api/CompanyProcessApi~getCompanyProcessListCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/CompanyProcessApi~getCompanyProcessListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/CustomProcessScenario>}
     */
    this.getCompanyProcessList = function(authorization, companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling getCompanyProcessList");
      }

      // verify the required parameter 'companyId' is set
      if (companyId == undefined || companyId == null) {
        throw new Error("Missing the required parameter 'companyId' when calling getCompanyProcessList");
      }
     ...
     */
    this.updateCustomProcessScenario = function(authorization, companyId, code, body, callback) {
      var postBody = body;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling updateCustomProcessScenario");
      }
