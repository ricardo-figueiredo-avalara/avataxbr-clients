...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AvaTaxBrazil.CompanyApi = factory(root.AvaTaxBrazil.ApiClient, root.AvaTaxBrazil.Company, root.AvaTaxBrazil.Message, root.AvaTaxBrazil.ValidationError);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.createCompany = function(authorization, body, callback) {
      var postBody = body;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling createCompany");
      }
     ...
     */
    this.deleteAccountCompany = function(authorization, accountId, companyId, callback) {
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling deleteAccountCompany");
      }
     ...
     */
    this.deleteCompany = function(authorization, companyId, companyId2, callback) {
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling deleteCompany");
      }
     ...
     * @callback module:api/CompanyApi~getCompaniesListCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} authorization Bearer {auth}
     * @param {module:api/CompanyApi~getCompaniesListCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/Company>}
     */
    this.getCompaniesList = function(authorization, callback) {
      var postBody = null;
     ...
     * data is of type: {@link module:model/Company}
     */
    this.infoCompany = function(authorization, companyId, callback) {
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling infoCompany");
      }
     ...
     */
    this.updateCompany = function(authorization, companyId, body, callback) {
      var postBody = body;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling updateCompany");
      }
