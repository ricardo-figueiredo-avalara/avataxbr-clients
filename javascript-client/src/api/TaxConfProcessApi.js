...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Br16Api.TaxConfProcessApi = factory(root.Br16Api.ApiClient, root.Br16Api.InlineResponse201, root.Br16Api.Message, root.Br16Api.ProcessScenario, root.Br16Api.ValidationError);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.createProcess = function(taxconfprocess, callback) {
     ...
     */
    this.deleteProcess = function(code, callback) {
      var postBody = null;
     ...
     */
    this.getProcess = function(code, callback) {
      var postBody = null;
     ...
     */
    this.getProcessList = function(opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.updateProcess = function(code, taxconfprocess, callback) {
      var postBody = taxconfprocess;
