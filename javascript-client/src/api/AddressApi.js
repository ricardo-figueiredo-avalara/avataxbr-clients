...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.AvaTaxBrazil.AddressApi = factory(root.AvaTaxBrazil.ApiClient, root.AvaTaxBrazil.Address, root.AvaTaxBrazil.Message, root.AvaTaxBrazil.ValidationError);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.getZipCode = function(authorization, zipcode, callback) {
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling getZipCode");
      }
