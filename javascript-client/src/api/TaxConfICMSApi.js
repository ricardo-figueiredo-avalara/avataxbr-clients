...
(function(root, factory) {
  ...
  var exports = function(apiClient) {
     ...
     */
    this.createIcmsconfstate = function(authorization, state, icmsConfState, callback) {
      var postBody = icmsConfState;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling createIcmsconfstate");
      }
     ...
     */
    this.deleteIcmsConf = function(authorization, state, code, callback) {
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling deleteIcmsConf");
      }
     ...
     */
    this.getIcmsConfByState = function(authorization, state, code, callback) {
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling getIcmsConfByState");
      }
     ...
     * data is of type: {@link Array.<module:model/IcmsConfByState>}
     */
    this.getIcmsList = function(authorization, state, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling getIcmsList");
      }
    ...
    /**
     * Callback function to receive the result of the getIcmsListSearch operation.
     * @callback module:api/TaxConfICMSApi~getIcmsListSearchCallback
     * @param {String} error Error message, if any.
     * @param {Array.<module:model/IcmsConfByState>} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:api/TaxConfICMSApi~getIcmsListSearchCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/IcmsConfByState>}
     */
    this.getIcmsListSearch = function(authorization, text, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling getIcmsListSearch");
      }

      // verify the required parameter 'text' is set
      if (text == undefined || text == null) {
        throw new Error("Missing the required parameter 'text' when calling getIcmsListSearch");
      }
     ...
     */
    this.updateIcmsconfstate = function(authorization, state, code, icmsConfState, callback) {
      var postBody = icmsConfState;

      // verify the required parameter 'authorization' is set
      if (authorization == undefined || authorization == null) {
        throw new Error("Missing the required parameter 'authorization' when calling updateIcmsconfstate");
      }
