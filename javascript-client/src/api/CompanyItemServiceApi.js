...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Br16Api.CompanyItemServiceApi = factory(root.Br16Api.ApiClient, root.Br16Api.Body1, root.Br16Api.InlineResponse201, root.Br16Api.ItemSimple, root.Br16Api.Message, root.Br16Api.ValidationError);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/CompanyItemServiceApi~companiesCompanyIdItemsCodeChangeCodePutCallback
     ...
     * @param {module:api/CompanyItemServiceApi~companiesCompanyIdItemsCodeChangeCodePutCallback} callback The callback function, accepting three arguments: error, data, response
     */
    ...
    /**
     * Callback function to receive the result of the companiesCompanyIdItemsCodeserviceGet operation.
     * @callback module:api/CompanyItemServiceApi~companiesCompanyIdItemsCodeserviceGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/CompanyItemServiceApi~companiesCompanyIdItemsCodeserviceGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/ItemSimple}
     */
    this.companiesCompanyIdItemsCodeserviceGet = function(companyId, code, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId == undefined || companyId == null) {
        throw new Error("Missing the required parameter 'companyId' when calling companiesCompanyIdItemsCodeserviceGet");
      }

      // verify the required parameter 'code' is set
      if (code == undefined || code == null) {
        throw new Error("Missing the required parameter 'code' when calling companiesCompanyIdItemsCodeserviceGet");
      }
    ...
    /**
     * Callback function to receive the result of the companiesCompanyIdItemsserviceGet operation.
     * @callback module:api/CompanyItemServiceApi~companiesCompanyIdItemsserviceGetCallback
     * @param {String} error Error message, if any.
     ...
     * @param {String} opts.agast Custom Agast Code
     * @param {module:api/CompanyItemServiceApi~companiesCompanyIdItemsserviceGetCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link Array.<module:model/ItemSimple>}
     */
    this.companiesCompanyIdItemsserviceGet = function(companyId, opts, callback) {
      opts = opts || {};
      var postBody = null;

      // verify the required parameter 'companyId' is set
      if (companyId == undefined || companyId == null) {
        throw new Error("Missing the required parameter 'companyId' when calling companiesCompanyIdItemsserviceGet");
      }
     ...
     */
    this.createItemService = function(companyId, body, opts, callback) {
      opts = opts || {};
      var postBody = body;
     ...
     */
    this.deleteItemService = function(companyId, code, opts, callback) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.updateItemService = function(companyId, code, body, opts, callback) {
      opts = opts || {};
      var postBody = body;
