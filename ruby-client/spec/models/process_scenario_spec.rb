...
# Unit tests for SwaggerClient::ProcessScenario
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'ProcessScenario' do
  before do
    # run before each test
    @instance = SwaggerClient::ProcessScenario.new
  end
  ...
  describe 'test an instance of ProcessScenario' do
    it 'should create an instact of ProcessScenario' do
      expect(@instance).to be_instance_of(SwaggerClient::ProcessScenario)
    end
  end
