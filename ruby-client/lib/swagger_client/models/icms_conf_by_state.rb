...
module SwaggerClient
  ...
  class IcmsConfByState
    ...
    def hash
      [code, state, name, start_date, expiration_date, inactive, subject_to_st, icms_cst, calc_mode, discount_rate_for_mono_phase, rate, icms_base_discount, msrp, mva_rate, msrp_unit, icms_legal_reason, fcp_rate, icms_st_conf, icms_inter_state_conf].hash
    end
