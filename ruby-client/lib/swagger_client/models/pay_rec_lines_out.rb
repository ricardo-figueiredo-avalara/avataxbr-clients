...
module SwaggerClient
  ...
  class PayRecLinesOut
    ...
    attr_accessor :item_doc_number

    # Penalty, usually because paid after due date
    attr_accessor :line_untaxed_penality
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'lineType')
        self.line_type = attributes[:'lineType']
      end
      ...
      if attributes.has_key?(:'itemDocNumber')
        self.item_doc_number = attributes[:'itemDocNumber']
      end

      if attributes.has_key?(:'lineUntaxedPenality')
        self.line_untaxed_penality = attributes[:'lineUntaxedPenality']
      end
    ...
    def valid?
      line_type_validator = EnumAttributeValidator.new('String', ["installment"])
      return false unless line_type_validator.valid?(@line_type)
      return false if @item_code.nil?
      return true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] line_type Object to be assigned
    def line_type=(line_type)
      validator = EnumAttributeValidator.new('String', ["installment"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          item_doc_number == o.item_doc_number &&
          line_untaxed_penality == o.line_untaxed_penality &&
    ...
    def hash
      [line_code, line_type, item_code, item_description, item_doc_number, line_untaxed_penality, line_untaxed_discount, line_amount, line_net_value, withholding_mode, calculated_tax].hash
    end
