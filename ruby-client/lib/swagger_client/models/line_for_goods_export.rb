...
module SwaggerClient
  ...
  class LineForGoodsExport
    attr_accessor :drawback_number

    attr_accessor :ind_export
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'indExport')
        self.ind_export = attributes[:'indExport']
      end
    ...
    def list_invalid_properties
      ...
      if !@drawback_number.nil? && @drawback_number.to_s.length > 11
        invalid_properties.push("invalid value for 'drawback_number', the character length must be smaller than or equal to 11.")
      end
    ...
    def valid?
      return false if !@drawback_number.nil? && @drawback_number.to_s.length > 11
    ...
    def drawback_number=(drawback_number)
      ...
      if !drawback_number.nil? && drawback_number.to_s.length > 11
        fail ArgumentError, "invalid value for 'drawback_number', the character length must be smaller than or equal to 11."
      end
    ...
    def hash
      [drawback_number, ind_export].hash
    end
