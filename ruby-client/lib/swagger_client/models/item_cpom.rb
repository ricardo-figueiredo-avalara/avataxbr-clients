...
module SwaggerClient
  ...
  class ItemCpom
    ...
    def list_invalid_properties
      ...
      if @city_code !~ Regexp.new(/[0-9]{7}/)
        invalid_properties.push("invalid value for 'city_code', must conform to the pattern /[0-9]{7}/.")
      end
    ...
    def valid?
      ...
      return false if @city_code !~ Regexp.new(/[0-9]{7}/)
    ...
    def city_code=(city_code)
      if city_code.nil?
        fail ArgumentError, "city_code cannot be nil"
      end

      if city_code !~ Regexp.new(/[0-9]{7}/)
        fail ArgumentError, "invalid value for 'city_code', must conform to the pattern /[0-9]{7}/."
      end
    ...
    def hash
      [company_id, city_code, item_code, code].hash
    end
