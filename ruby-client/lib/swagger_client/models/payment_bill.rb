...
module SwaggerClient
  ...
  class PaymentBill
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'nFat')
        self.n_fat = attributes[:'nFat']
      end

      if attributes.has_key?(:'vOrig')
        self.v_orig = attributes[:'vOrig']
      end

      if attributes.has_key?(:'vDiscount')
        self.v_discount = attributes[:'vDiscount']
      end

      if attributes.has_key?(:'vNet')
        self.v_net = attributes[:'vNet']
      end
    ...
    def hash
      [n_fat, v_orig, v_discount, v_net].hash
    end
