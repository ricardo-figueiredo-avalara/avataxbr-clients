...
module SwaggerClient
  ...
  class IpbtConfItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'federalTax')
        self.federal_tax = attributes[:'federalTax']
      end

      if attributes.has_key?(:'importTax')
        self.import_tax = attributes[:'importTax']
      end
    ...
    def hash
      [state, federal_tax, import_tax, state_tax, city_tax, source].hash
    end
