...
module SwaggerClient
  ...
  class CfopConf
    ...
    attr_accessor :allow_ip_icredit_when_in_going
    ...
    attr_accessor :cod_in_state

    # CFOP code (tax code operation) when the transactions are to another state.
    attr_accessor :cod_other_state

    # CFOP code (tax code operation) when the transactions are to another country.
    attr_accessor :cod_other_country

    attr_accessor :cst_icms_same_state

    attr_accessor :cst_icms_other_state

    attr_accessor :cst_icms_other_country
    ...
    def self.swagger_types
      {
        ...
        :'description' => :'String',
        :'way_type' => :'String',
        :'cod_in_state' => :'Integer',
        :'cod_other_state' => :'Integer',
        :'cod_other_country' => :'Integer',
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'stockImpact')
        self.stock_impact = attributes[:'stockImpact']
      end

      if attributes.has_key?(:'financialImpact')
        self.financial_impact = attributes[:'financialImpact']
      end
      ...
      if attributes.has_key?(:'allowIPIcreditWhenInGoing')
        self.allow_ip_icredit_when_in_going = attributes[:'allowIPIcreditWhenInGoing']
      end
      ...
      if attributes.has_key?(:'wayType')
        self.way_type = attributes[:'wayType']
      end

      if attributes.has_key?(:'codInState')
        self.cod_in_state = attributes[:'codInState']
      end

      if attributes.has_key?(:'codOtherState')
        self.cod_other_state = attributes[:'codOtherState']
      end

      if attributes.has_key?(:'codOtherCountry')
        self.cod_other_country = attributes[:'codOtherCountry']
      end

      if attributes.has_key?(:'cstICMSSameState')
        self.cst_icms_same_state = attributes[:'cstICMSSameState']
      end

      if attributes.has_key?(:'cstICMSOtherState')
        self.cst_icms_other_state = attributes[:'cstICMSOtherState']
      end

      if attributes.has_key?(:'cstICMSOtherCountry')
        self.cst_icms_other_country = attributes[:'cstICMSOtherCountry']
      end
      ...
      if attributes.has_key?(:'operationToTaxPayerOtherState')
        self.operation_to_tax_payer_other_state = attributes[:'operationToTaxPayerOtherState']
      end

      if attributes.has_key?(:'operationWithST')
        self.operation_with_st = attributes[:'operationWithST']
      end

      if attributes.has_key?(:'operationToFreeZone')
        self.operation_to_free_zone = attributes[:'operationToFreeZone']
      end

      if attributes.has_key?(:'specificForProductClass')
        self.specific_for_product_class = attributes[:'specificForProductClass']
      end
    ...
    def list_invalid_properties
      ...
      if @code.to_s.length > 40
        invalid_properties.push("invalid value for 'code', the character length must be smaller than or equal to 40.")
      end

      if !@pis_exempt_legal_reason_code.nil? && @pis_exempt_legal_reason_code.to_s.length > 3
        invalid_properties.push("invalid value for 'pis_exempt_legal_reason_code', the character length must be smaller than or equal to 3.")
      end
      ...
      if !@cofins_exempt_legal_reason_code.nil? && @cofins_exempt_legal_reason_code.to_s.length > 3
        invalid_properties.push("invalid value for 'cofins_exempt_legal_reason_code', the character length must be smaller than or equal to 3.")
      end
    ...
    def valid?
      ...
      way_type_validator = EnumAttributeValidator.new('String', ["in", "out"])
      return false unless way_type_validator.valid?(@way_type)
      product_type_validator = EnumAttributeValidator.new('String', ["FOR PRODUCT", "FOR MERCHANDISE", "NO RESTRICTION"])
      return false unless product_type_validator.valid?(@product_type)
      specific_for_product_class_validator = EnumAttributeValidator.new('String', ["OTHERS", "COMMUNICATION", "ENERGY", "TRANSPORT", "FUEL AND LUBRIFICANT", "VEHICLE", "ALCOHOLIC BEVERAGES", "WEAPONS", "AMMO", "PERFUM", "TOBACCO"])
      return false unless specific_for_product_class_validator.valid?(@specific_for_product_class)
      return true
    end
    ...
    def code=(code)
      ...
      if code.to_s.length > 40
        fail ArgumentError, "invalid value for 'code', the character length must be smaller than or equal to 40."
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] pis_exempt_legal_reason_code Value to be assigned
    def pis_exempt_legal_reason_code=(pis_exempt_legal_reason_code)

      if !pis_exempt_legal_reason_code.nil? && pis_exempt_legal_reason_code.to_s.length > 3
        fail ArgumentError, "invalid value for 'pis_exempt_legal_reason_code', the character length must be smaller than or equal to 3."
      end

      @pis_exempt_legal_reason_code = pis_exempt_legal_reason_code
    end
    ...
    # Custom attribute writer method with validation
    # @param [Object] cofins_exempt_legal_reason_code Value to be assigned
    def cofins_exempt_legal_reason_code=(cofins_exempt_legal_reason_code)

      if !cofins_exempt_legal_reason_code.nil? && cofins_exempt_legal_reason_code.to_s.length > 3
        fail ArgumentError, "invalid value for 'cofins_exempt_legal_reason_code', the character length must be smaller than or equal to 3."
      end

      @cofins_exempt_legal_reason_code = cofins_exempt_legal_reason_code
    end
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] way_type Object to be assigned
    def way_type=(way_type)
      validator = EnumAttributeValidator.new('String', ["in", "out"])
      unless validator.valid?(way_type)
        fail ArgumentError, "invalid value for 'way_type', must be one of #{validator.allowable_values}."
      end
      @way_type = way_type
    end
    ...
    def product_type=(product_type)
      validator = EnumAttributeValidator.new('String', ["FOR PRODUCT", "FOR MERCHANDISE", "NO RESTRICTION"])
    ...
    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] specific_for_product_class Object to be assigned
    def specific_for_product_class=(specific_for_product_class)
      validator = EnumAttributeValidator.new('String', ["OTHERS", "COMMUNICATION", "ENERGY", "TRANSPORT", "FUEL AND LUBRIFICANT", "VEHICLE", "ALCOHOLIC BEVERAGES", "WEAPONS", "AMMO", "PERFUM", "TOBACCO"])
      unless validator.valid?(specific_for_product_class)
        fail ArgumentError, "invalid value for 'specific_for_product_class', must be one of #{validator.allowable_values}."
      end
      @specific_for_product_class = specific_for_product_class
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          allow_ip_icredit_when_in_going == o.allow_ip_icredit_when_in_going &&
          icms_conf == o.icms_conf &&
          name == o.name &&
          description == o.description &&
          way_type == o.way_type &&
          cod_in_state == o.cod_in_state &&
          cod_other_state == o.cod_other_state &&
          cod_other_country == o.cod_other_country &&
          cst_icms_same_state == o.cst_icms_same_state &&
          cst_icms_other_state == o.cst_icms_other_state &&
          cst_icms_other_country == o.cst_icms_other_country &&
          product_type == o.product_type &&
          operation_to_tax_payer_other_state == o.operation_to_tax_payer_other_state &&
          operation_with_st == o.operation_with_st &&
          operation_to_free_zone == o.operation_to_free_zone &&
          specific_for_product_class == o.specific_for_product_class
    end
    ...
    def hash
      [code, stock_impact, financial_impact, cst_ipi, ipi_legal_tax_class, accruable_pis_taxation, pis_exempt_legal_reason_code, pis_exempt_legal_reason, accruable_cofins_taxation, cofins_exempt_legal_reason_code, cofins_exempt_legal_reason, allow_ip_icredit_when_in_going, icms_conf, name, description, way_type, cod_in_state, cod_other_state, cod_other_country, cst_icms_same_state, cst_icms_other_state, cst_icms_other_country, product_type, operation_to_tax_payer_other_state, operation_with_st, operation_to_free_zone, specific_for_product_class].hash
    end
