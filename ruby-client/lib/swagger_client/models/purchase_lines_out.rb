...
module SwaggerClient
  ...
  class PurchaseLinesOut
    ...
    def hash
      [line_code, item_code, number_of_items, line_amount, item_description, line_taxed_discount, line_untaxed_discount, use_type, tax_deductions, avalara_goods_and_services_type, line_net_value, calculated_tax].hash
    end
