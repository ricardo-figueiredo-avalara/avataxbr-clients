...
module SwaggerClient
  ...
  class EntityForGoods
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'icmsTaxPayer')
        self.icms_tax_payer = attributes[:'icmsTaxPayer']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          icms_tax_payer == o.icms_tax_payer
    end
    ...
    def hash
      [name, role, type, federal_tax_id, city_tax_id, state_tax_id, suframa, phone, tax_regime, email, subject_to_srf1234, icms_tax_payer].hash
    end
