...
module SwaggerClient
  ...
  class DetailsCalculatedTaxItem
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'cstB')
        self.cst_b = attributes[:'cstB']
      end

      if attributes.has_key?(:'modBC')
        self.mod_bc = attributes[:'modBC']
      end
    ...
    def hash
      [location_type, jurisdiction_name, jurisdiction_type, tax_type, rate_type, scenario, subtotal_taxable, rate, tax, exemption_code, significant_locations, tax_rule_type, source, cst_b, mod_bc, cst].hash
    end
