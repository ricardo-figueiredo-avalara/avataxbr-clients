...
module SwaggerClient
  ...
  class ProcessScenario
    ...
    def hash
      [code, stock_impact, financial_impact, cst_ipi, ipi_legal_tax_class, accruable_pis_taxation, pis_exempt_legal_reason_code, pis_exempt_legal_reason, accruable_cofins_taxation, cofins_exempt_legal_reason_code, cofins_exempt_legal_reason, allow_ip_icredit_when_in_going, icms_conf, name, type, way_type, goal, over_write_cfop, cfops].hash
    end
