...
module SwaggerClient
  ...
  class IcmsTaxConf
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'messageCode')
        self.message_code = attributes[:'messageCode']
      end

      if attributes.has_key?(:'relationShip')
        if (value = attributes[:'relationShip']).is_a?(Array)
          self.relation_ship = value
        end
      end
    ...
    def list_invalid_properties
      ...
      if !@message_code.nil? && @message_code.to_s.length > 60
        invalid_properties.push("invalid value for 'message_code', the character length must be smaller than or equal to 60.")
      end
    ...
    def valid?
      ...
      return false if !@message_code.nil? && @message_code.to_s.length > 60
      return true
    end
    ...
    def message_code=(message_code)
      ...
      if !message_code.nil? && message_code.to_s.length > 60
        fail ArgumentError, "invalid value for 'message_code', the character length must be smaller than or equal to 60."
      end
    ...
    def hash
      [state, icms_cst, message_code, relation_ship].hash
    end
