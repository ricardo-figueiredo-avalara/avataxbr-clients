...
module SwaggerClient
  ...
  class DefaultLocations
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deliveryLocation')
        self.delivery_location = attributes[:'deliveryLocation']
      end

      if attributes.has_key?(:'pickupLocation')
        self.pickup_location = attributes[:'pickupLocation']
      end
    ...
    def hash
      [entity, company, transporter, delivery_location, pickup_location].hash
    end
