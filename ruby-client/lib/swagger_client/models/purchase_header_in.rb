...
module SwaggerClient
  ...
  class PurchaseHeaderIn
    ...
    def hash
      [account_id, company_code, transaction_type, document_code, currency, transaction_date, tax_calculation_date, company_location, vendor_code, purchase_order_number, entity, payment, taxes_config, default_locations].hash
    end
