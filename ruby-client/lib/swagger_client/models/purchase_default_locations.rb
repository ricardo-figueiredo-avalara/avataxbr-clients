...
module SwaggerClient
  ...
  class PurchaseDefaultLocations
    attr_accessor :point_of_order_origin
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'PointOfOrderOrigin')
        self.point_of_order_origin = attributes[:'PointOfOrderOrigin']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          point_of_order_origin == o.point_of_order_origin
    end
