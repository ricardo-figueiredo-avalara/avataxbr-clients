...
module SwaggerClient
  ...
  class Error
    ...
    def valid?
      ...
      _in_validator = EnumAttributeValidator.new('String', ["params", "body", "query"])
    ...
    def _in=(_in)
      validator = EnumAttributeValidator.new('String', ["params", "body", "query"])
    ...
    def hash
      [code, message, field, value, _in].hash
    end
