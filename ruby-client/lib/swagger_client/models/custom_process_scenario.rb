...
module SwaggerClient
  ...
  class CustomProcessScenario
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'overWriteCFOP')
        self.over_write_cfop = attributes[:'overWriteCFOP']
      end

      if attributes.has_key?(:'cfops')
        if (value = attributes[:'cfops']).is_a?(Array)
          self.cfops = value
        end
      end
    ...
    def valid?
      ...
      type_validator = EnumAttributeValidator.new('String', ["SALES", "PURCHASE", "SALES_RETURN", "PURCHASE_RETURN", "TRANSFER_RETURN", "SHIPPING", "SHIPPING_RETURN", "TRANSFER", "RECEIPT_AJUSTE", "TRANSFER_AJUSTE"])
      ...
      goal_validator = EnumAttributeValidator.new('String', ["Normal", "Complementary", "Voided", "Replacement", "Return", "Adjustment"])
    ...
    def type=(type)
      validator = EnumAttributeValidator.new('String', ["SALES", "PURCHASE", "SALES_RETURN", "PURCHASE_RETURN", "TRANSFER_RETURN", "SHIPPING", "SHIPPING_RETURN", "TRANSFER", "RECEIPT_AJUSTE", "TRANSFER_AJUSTE"])
    ...
    def goal=(goal)
      validator = EnumAttributeValidator.new('String', ["Normal", "Complementary", "Voided", "Replacement", "Return", "Adjustment"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          way_type == o.way_type &&
          goal == o.goal &&
          over_write_cfop == o.over_write_cfop &&
          cfops == o.cfops &&
    ...
    def hash
      [code, stock_impact, financial_impact, cst_ipi, ipi_legal_tax_class, accruable_pis_taxation, pis_exempt_legal_reason_code, pis_exempt_legal_reason, accruable_cofins_taxation, cofins_exempt_legal_reason_code, cofins_exempt_legal_reason, allow_ip_icredit_when_in_going, icms_conf, name, type, way_type, goal, over_write_cfop, cfops, company_id].hash
    end
