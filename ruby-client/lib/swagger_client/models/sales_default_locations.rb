...
module SwaggerClient
  ...
  class SalesDefaultLocations
    attr_accessor :service_rendered
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'serviceRendered')
        self.service_rendered = attributes[:'serviceRendered']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          service_rendered == o.service_rendered
    end
