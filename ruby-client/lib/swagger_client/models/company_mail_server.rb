...
module SwaggerClient
  ...
  class CompanyMailServer
    ...
    attr_accessor :templatemessage_to_email
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'smtpAddress')
        self.smtp_address = attributes[:'smtpAddress']
      end
      ...
      if attributes.has_key?(:'templatemessageToEmail')
        self.templatemessage_to_email = attributes[:'templatemessageToEmail']
      end
    ...
    def valid?
      protocol_validator = EnumAttributeValidator.new('String', ["ssl", "tls"])
    ...
    def protocol=(protocol)
      validator = EnumAttributeValidator.new('String', ["ssl", "tls"])
    ...
    def ==(o)
      ...
      self.class == o.class &&
          user == o.user &&
          password == o.password &&
          smtp_address == o.smtp_address &&
          port == o.port &&
          email_from == o.email_from &&
          protocol == o.protocol &&
          templatemessage_to_email == o.templatemessage_to_email
    end
    ...
    def hash
      [user, password, smtp_address, port, email_from, protocol, templatemessage_to_email].hash
    end
