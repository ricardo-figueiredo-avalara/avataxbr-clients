...
public class InvoiceSEFAZApiTest {
    ...
    public void cancelInvoiceTest() throws ApiException {
        ...
        SefazInvoiceBasicStatus response = api.cancelInvoice(authorization, key, body);
     ...
     */
    @Test
    public void disableRangeTest() throws ApiException {
        String authorization = null;
        SefazDisableRangeIn body = null;
        SefazInvoiceBasicStatus response = api.disableRange(authorization, body);
     ...
     */
    @Test
    public void fixLetterTest() throws ApiException {
        String authorization = null;
        String key = null;
        SefazItPutIn body = null;
        SefazInvoiceBasicStatus response = api.fixLetter(authorization, key, body);
    ...
    public void retrieveInvoiceTest() throws ApiException {
        String authorization = null;
        String key = null;
        SefazItGetOut response = api.retrieveInvoice(authorization, key);
     ...
     */
    @Test
    public void retrieveInvoiceLookupTest() throws ApiException {
        String authorization = null;
        String key = null;
        TransactionForSefazGoodsList response = api.retrieveInvoiceLookup(authorization, key);
     ...
     */
    @Test
    public void retrieveStatusTest() throws ApiException {
        String authorization = null;
        String response = api.retrieveStatus(authorization);
    ...
    public void sendInvoiceTest() throws ApiException {
        String authorization = null;
        TransactionForSefazGoodsList body = null;
        SefazPostOut response = api.sendInvoice(authorization, body);
