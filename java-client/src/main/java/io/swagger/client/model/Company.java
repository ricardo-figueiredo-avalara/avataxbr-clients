...
public class Company {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, officialName, name, entityType, subjectToSRF1234, federalTaxRegime, pisSubjectTo, cofinsSubjectTo, csllSubjectTo, receiptsAreFullNoCumulativePisCofins, inssWithholdSubjectTo, issWithholdSubjectTo, irrfWithholdSubjectTo, icmsRateForSimplestaxregime, isExemptByGrossRevenueForSimplestaxregime, _configuration, mailServer, authorizedToDownloadNFe);
  }
