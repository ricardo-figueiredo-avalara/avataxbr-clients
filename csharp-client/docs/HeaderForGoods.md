...
**EDocCreatorPerspective** | **bool?** | This Flag is used only when eDocCreatorType is other and the return show Taxes using eDocCreator perspective or self perspective. | [optional] [default to true]
...
**InvoiceNumber** | **int?** | Invoice number, sequential unique by invoice serial (Número da nota fiscal) | 
**InvoiceSerial** | **int?** | Invoice number, sequential unique by invoice serial (Número da nota fiscal)  | 
