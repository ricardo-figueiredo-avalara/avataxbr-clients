...
**ManufacturerEquivalent** | **bool?** | Item is merchandise but will be considered product | [optional] 
**AppropriateIPIcreditWhenInGoing** | **bool?** | Inform that this item will have rights to aprropriate IPI credit | [optional] 
**UsuallyAppropriatePISCOFINSCredit** | **bool?** | Subject to appropriate PIS/COFINS credit, when NO CUMULATIVE | [optional] 
