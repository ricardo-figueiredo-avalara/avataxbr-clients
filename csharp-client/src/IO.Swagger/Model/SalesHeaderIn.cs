...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesHeaderIn :  IEquatable<SalesHeaderIn>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesHeaderIn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SalesHeaderIn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesHeaderIn" /> class.
        /// </summary>
        ...
        public SalesHeaderIn(string AccountId = default(string), string CompanyCode = default(string), TransactionTypeEnum? TransactionType = default(TransactionTypeEnum?), string DocumentCode = default(string), CurrencyEnum? Currency = default(CurrencyEnum?), DateTime? TransactionDate = default(DateTime?), DateTime? TaxCalculationDate = default(DateTime?), string CompanyLocation = default(string), string CustomerCode = default(string), string PurchaseOrderNumber = default(string), int? RpsNumber = default(int?), string RpsSerie = "0", string DiscriminationIn = default(string), SalesEntity Entity = default(SalesEntity), SalesHeaderInPayment Payment = default(SalesHeaderInPayment), SalesTaxesConfig TaxesConfig = default(SalesTaxesConfig), SalesDefaultLocations DefaultLocations = default(SalesDefaultLocations))
        {
            // to ensure "AccountId" is required (not null)
            if (AccountId == null)
            {
                throw new InvalidDataException("AccountId is a required property for SalesHeaderIn and cannot be null");
            }
            else
            {
            ...
            if (CompanyCode == null)
            {
                throw new InvalidDataException("CompanyCode is a required property for SalesHeaderIn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TransactionType is a required property for SalesHeaderIn and cannot be null");
            }
            else
            {
            ...
            if (Currency == null)
            {
                throw new InvalidDataException("Currency is a required property for SalesHeaderIn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TransactionDate is a required property for SalesHeaderIn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CompanyLocation is a required property for SalesHeaderIn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CustomerCode is a required property for SalesHeaderIn and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SalesHeaderIn);
        }

        /// <summary>
        /// Returns true if SalesHeaderIn instances are equal
        /// </summary>
        /// <param name="other">Instance of SalesHeaderIn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesHeaderIn other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
