...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayRecCalculatedTaxSummaryForService :  IEquatable<PayRecCalculatedTaxSummaryForService>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayRecCalculatedTaxSummaryForService" /> class.
        /// </summary>
        /// <param name="NumberOfLines">Count of lines.</param>
        /// <param name="Subtotal">Sum of grossvalues.</param>
        /// <param name="TotalTax">Sum of all withholding values.</param>
        /// <param name="GrandTotal">Sum all NetValues.</param>
        /// <param name="PccWithholdingModes">PccWithholdingModes.</param>
        /// <param name="TaxByType">TaxByType.</param>
        public PayRecCalculatedTaxSummaryForService(int? NumberOfLines = default(int?), double? Subtotal = default(double?), double? TotalTax = default(double?), double? GrandTotal = default(double?), List<PccWithholdingMode> PccWithholdingModes = default(List<PccWithholdingMode>), PayRecCalculatedTaxSummaryForServiceTaxByType TaxByType = default(PayRecCalculatedTaxSummaryForServiceTaxByType))
        {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PayRecCalculatedTaxSummaryForService);
        }

        /// <summary>
        /// Returns true if PayRecCalculatedTaxSummaryForService instances are equal
        /// </summary>
        /// <param name="other">Instance of PayRecCalculatedTaxSummaryForService to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayRecCalculatedTaxSummaryForService other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    this.PccWithholdingModes == other.PccWithholdingModes ||
                    this.PccWithholdingModes != null &&
                    this.PccWithholdingModes.SequenceEqual(other.PccWithholdingModes)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PccWithholdingModes != null)
                    hash = hash * 59 + this.PccWithholdingModes.GetHashCode();
