...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseHeaderIn :  IEquatable<PurchaseHeaderIn>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseHeaderIn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PurchaseHeaderIn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseHeaderIn" /> class.
        /// </summary>
        ...
        public PurchaseHeaderIn(string AccountId = default(string), string CompanyCode = default(string), TransactionTypeEnum? TransactionType = default(TransactionTypeEnum?), string DocumentCode = default(string), CurrencyEnum? Currency = default(CurrencyEnum?), DateTime? TransactionDate = default(DateTime?), DateTime? TaxCalculationDate = default(DateTime?), string CompanyLocation = default(string), string VendorCode = default(string), string PurchaseOrderNumber = default(string), PurchaseEntity Entity = default(PurchaseEntity), PurchaseHeaderInPayment Payment = default(PurchaseHeaderInPayment), PurchaseTaxesConfig TaxesConfig = default(PurchaseTaxesConfig), PurchaseDefaultLocations DefaultLocations = default(PurchaseDefaultLocations))
        {
            // to ensure "AccountId" is required (not null)
            if (AccountId == null)
            {
                throw new InvalidDataException("AccountId is a required property for PurchaseHeaderIn and cannot be null");
            }
            else
            {
            ...
            if (CompanyCode == null)
            {
                throw new InvalidDataException("CompanyCode is a required property for PurchaseHeaderIn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TransactionType is a required property for PurchaseHeaderIn and cannot be null");
            }
            else
            {
            ...
            if (Currency == null)
            {
                throw new InvalidDataException("Currency is a required property for PurchaseHeaderIn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("TransactionDate is a required property for PurchaseHeaderIn and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("CompanyLocation is a required property for PurchaseHeaderIn and cannot be null");
            }
            else
            {
            ...
            if (VendorCode == null)
            {
                throw new InvalidDataException("VendorCode is a required property for PurchaseHeaderIn and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PurchaseHeaderIn);
        }

        /// <summary>
        /// Returns true if PurchaseHeaderIn instances are equal
        /// </summary>
        /// <param name="other">Instance of PurchaseHeaderIn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseHeaderIn other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
