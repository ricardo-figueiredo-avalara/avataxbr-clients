...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayRecCalculatedTaxSummaryForServiceTaxByType :  IEquatable<PayRecCalculatedTaxSummaryForServiceTaxByType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayRecCalculatedTaxSummaryForServiceTaxByType" /> class.
        /// </summary>
        ...
        public PayRecCalculatedTaxSummaryForServiceTaxByType(TaxByTypeSummaryForService IssRf = default(TaxByTypeSummaryForService), TaxByTypeSummaryForService PisRf = default(TaxByTypeSummaryForService), TaxByTypeSummaryForService CofinsRf = default(TaxByTypeSummaryForService), TaxByTypeSummaryForService CsllRf = default(TaxByTypeSummaryForService), TaxByTypeSummaryForService Irrf = default(TaxByTypeSummaryForService), TaxByTypeSummaryForService InssRf = default(TaxByTypeSummaryForService))
        {
            this.IssRf = IssRf;
            this.PisRf = PisRf;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PayRecCalculatedTaxSummaryForServiceTaxByType);
        }

        /// <summary>
        /// Returns true if PayRecCalculatedTaxSummaryForServiceTaxByType instances are equal
        /// </summary>
        /// <param name="other">Instance of PayRecCalculatedTaxSummaryForServiceTaxByType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayRecCalculatedTaxSummaryForServiceTaxByType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
