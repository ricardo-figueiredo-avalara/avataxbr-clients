...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentLinesIn :  IEquatable<PaymentLinesIn>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentLinesIn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PaymentLinesIn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentLinesIn" /> class.
        /// </summary>
        ...
        public PaymentLinesIn(int? LineCode = default(int?), LineTypeEnum? LineType = default(LineTypeEnum?), string ItemCode = default(string), string ItemDescription = default(string), string ItemDocNumber = default(string), double? LineUntaxedPenality = default(double?), double? LineUntaxedDiscount = default(double?), double? LineNetValue = default(double?))
        {
            // to ensure "ItemCode" is required (not null)
            if (ItemCode == null)
            {
                throw new InvalidDataException("ItemCode is a required property for PaymentLinesIn and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentLinesIn);
        }

        /// <summary>
        /// Returns true if PaymentLinesIn instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentLinesIn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentLinesIn other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
