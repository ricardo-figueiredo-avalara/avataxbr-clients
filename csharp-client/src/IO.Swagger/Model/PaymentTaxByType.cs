...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PaymentTaxByType :  IEquatable<PaymentTaxByType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentTaxByType" /> class.
        /// </summary>
        ...
        public PaymentTaxByType(TaxByTypeTax Irrf = default(TaxByTypeTax), TaxByTypeTax InssRf = default(TaxByTypeTax), TaxByTypeTax IssRf = default(TaxByTypeTax), TaxByTypeTax PisRf = default(TaxByTypeTax), TaxByTypeTax CofinsRf = default(TaxByTypeTax), TaxByTypeTax CsllRf = default(TaxByTypeTax))
        {
            this.Irrf = Irrf;
            this.InssRf = InssRf;
            this.IssRf = IssRf;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PaymentTaxByType);
        }

        /// <summary>
        /// Returns true if PaymentTaxByType instances are equal
        /// </summary>
        /// <param name="other">Instance of PaymentTaxByType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PaymentTaxByType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
