...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PurchaseTaxByType :  IEquatable<PurchaseTaxByType>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PurchaseTaxByType" /> class.
        /// </summary>
        ...
        public PurchaseTaxByType(TaxByTypeTax IssRf = default(TaxByTypeTax), TaxByTypeTax PisRf = default(TaxByTypeTax), TaxByTypeTax CofinsRf = default(TaxByTypeTax), TaxByTypeTax CsllRf = default(TaxByTypeTax), TaxByTypeTax Irrf = default(TaxByTypeTax), TaxByTypeTax InssRf = default(TaxByTypeTax), TaxByTypeTax InssAr = default(TaxByTypeTax), TaxByTypeTax Pis = default(TaxByTypeTax), TaxByTypeTax Cofins = default(TaxByTypeTax))
        {
            this.IssRf = IssRf;
            this.PisRf = PisRf;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PurchaseTaxByType);
        }

        /// <summary>
        /// Returns true if PurchaseTaxByType instances are equal
        /// </summary>
        /// <param name="other">Instance of PurchaseTaxByType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PurchaseTaxByType other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
