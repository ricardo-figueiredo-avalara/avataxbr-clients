...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ProcessScenario :  IEquatable<ProcessScenario>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessScenario" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected ProcessScenario() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="ProcessScenario" /> class.
        /// </summary>
        ...
        public ProcessScenario(string Code = default(string), bool? StockImpact = default(bool?), bool? FinancialImpact = default(bool?), CstIPIEnum? CstIPI = default(CstIPIEnum?), string IpiLegalTaxClass = default(string), AccruablePISTaxationEnum? AccruablePISTaxation = default(AccruablePISTaxationEnum?), string PisExemptLegalReasonCode = default(string), string PisExemptLegalReason = default(string), AccruableCOFINSTaxationEnum? AccruableCOFINSTaxation = default(AccruableCOFINSTaxationEnum?), string CofinsExemptLegalReasonCode = default(string), string CofinsExemptLegalReason = default(string), bool? AllowIPIcreditWhenInGoing = default(bool?), List<IcmsTaxConf> IcmsConf = default(List<IcmsTaxConf>), string Name = default(string), TypeEnum? Type = default(TypeEnum?), WayTypeEnum? WayType = default(WayTypeEnum?), GoalEnum? Goal = default(GoalEnum?), bool? OverWriteCFOP = default(bool?), List<CfopConf> Cfops = default(List<CfopConf>))
        {
            ...
            if (Name == null)
            {
                throw new InvalidDataException("Name is a required property for ProcessScenario and cannot be null");
            }
            else
            {
                this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ProcessScenario);
        }

        /// <summary>
        /// Returns true if ProcessScenario instances are equal
        /// </summary>
        /// <param name="other">Instance of ProcessScenario to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProcessScenario other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
