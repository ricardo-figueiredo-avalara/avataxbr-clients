...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesLinesIn :  IEquatable<SalesLinesIn>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesLinesIn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SalesLinesIn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesLinesIn" /> class.
        /// </summary>
        ...
        public SalesLinesIn(int? LineCode = default(int?), string ItemCode = default(string), double? NumberOfItems = 1.0, double? LineAmount = default(double?), string ItemDescription = default(string), double? LineTaxedDiscount = default(double?), double? LineUntaxedDiscount = default(double?), SalesLinesInTaxDeductions TaxDeductions = default(SalesLinesInTaxDeductions))
        {
            // to ensure "ItemCode" is required (not null)
            if (ItemCode == null)
            {
                throw new InvalidDataException("ItemCode is a required property for SalesLinesIn and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SalesLinesIn);
        }

        /// <summary>
        /// Returns true if SalesLinesIn instances are equal
        /// </summary>
        /// <param name="other">Instance of SalesLinesIn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesLinesIn other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
