...
namespace IO.Swagger.Model
{
    ...
    public partial class Entity :  IEquatable<Entity>, IValidatableObject
    {
        ...
        public Entity(string Name = default(string), RoleEnum? Role = default(RoleEnum?), EntityType Type = default(EntityType), string FederalTaxId = default(string), string CityTaxId = default(string), string StateTaxId = default(string), string Suframa = default(string), string Phone = default(string), TaxRegimeEnum? TaxRegime = default(TaxRegimeEnum?), string Email = default(string), bool? SubjectToSRF1234 = default(bool?))
        {
            ...
            {
                throw new InvalidDataException("FederalTaxId is a required property for Entity and cannot be null");
            }
            else
            {
