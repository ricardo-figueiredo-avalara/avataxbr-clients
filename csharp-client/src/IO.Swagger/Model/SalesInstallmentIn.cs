...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class SalesInstallmentIn :  IEquatable<SalesInstallmentIn>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesInstallmentIn" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected SalesInstallmentIn() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="SalesInstallmentIn" /> class.
        /// </summary>
        ...
        public SalesInstallmentIn(string DocumentNumber = default(string), DateTime? Date = default(DateTime?), double? GrossValue = default(double?))
        {
            // to ensure "DocumentNumber" is required (not null)
            if (DocumentNumber == null)
            {
                throw new InvalidDataException("DocumentNumber is a required property for SalesInstallmentIn and cannot be null");
            }
            else
            {
            ...
            if (Date == null)
            {
                throw new InvalidDataException("Date is a required property for SalesInstallmentIn and cannot be null");
            }
            else
            {
                this.Date = Date;
            ...
            if (GrossValue == null)
            {
                throw new InvalidDataException("GrossValue is a required property for SalesInstallmentIn and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as SalesInstallmentIn);
        }

        /// <summary>
        /// Returns true if SalesInstallmentIn instances are equal
        /// </summary>
        /// <param name="other">Instance of SalesInstallmentIn to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SalesInstallmentIn other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
