...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class EntityLocation :  IEquatable<EntityLocation>, IValidatableObject
    {
        /// <summary>
        ...
        public EntityLocation(string Street = default(string), string Neighborhood = default(string), string Zipcode = default(string), string CityCode = default(string), string CityName = default(string), StateEnum State = default(StateEnum), string CountryCode = "0", string Country = "BRA")
        {
            // to ensure "Zipcode" is required (not null)
            if (Zipcode == null)
            {
                throw new InvalidDataException("Zipcode is a required property for EntityLocation and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as EntityLocation);
        }

        /// <summary>
        /// Returns true if EntityLocation instances are equal
        /// </summary>
        /// <param name="other">Instance of EntityLocation to be compared</param>
        /// <returns>Boolean</returns>
