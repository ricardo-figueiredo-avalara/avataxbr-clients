...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class LineForSefazGoods :  IEquatable<LineForSefazGoods>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LineForSefazGoods" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LineForSefazGoods() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LineForSefazGoods" /> class.
        /// </summary>
        ...
        public LineForSefazGoods(int? LineCode = default(int?), string ItemCode = default(string), string AvalaraGoodsAndServicesType = default(string), double? NumberOfItems = 1.0, double? ReturnedPercentageAmount = default(double?), double? LineUnitPrice = default(double?), double? LineAmount = default(double?), string ItemDescription = default(string), double? LineTaxedDiscount = default(double?), double? LineUntaxedDiscount = default(double?), UseTypeEnum? UseType = default(UseTypeEnum?), string ProcessScenario = default(string), int? Cfop = default(int?), bool? HasStockImpact = default(bool?), bool? HasFinantialImpact = default(bool?), double? FreightAmount = default(double?), double? InsuranceAmount = default(double?), double? OtherCostAmount = default(double?), bool? IndTotType = true, string OrderNumber = default(string), string OrderItemNumber = default(string), string FciNumber = default(string), string RecopiNumber = default(string), string InfAdProd = default(string), Vehicle Vehicle = default(Vehicle), Medicine Medicine = default(Medicine), Weapon Weapon = default(Weapon), Fuel Fuel = default(Fuel), bool? EntityIsIcmsSubstitute = default(bool?), bool? IsTransportIcmsWithheld = default(bool?), LineForGoodsIcmsTaxRelief IcmsTaxRelief = default(LineForGoodsIcmsTaxRelief), List<LineForGoodsExport> Export = default(List<LineForGoodsExport>), List<LineForGoodsDi> Di = default(List<LineForGoodsDi>), LineForGoodsCalculatedTax CalculatedTax = default(LineForGoodsCalculatedTax), AgastExtendForSefaz Extend = default(AgastExtendForSefaz))
        {
            ...
            if (ItemCode == null)
            {
                throw new InvalidDataException("ItemCode is a required property for LineForSefazGoods and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("NumberOfItems is a required property for LineForSefazGoods and cannot be null");
            }
            else
            {
            ...
            if (LineAmount == null)
            {
                throw new InvalidDataException("LineAmount is a required property for LineForSefazGoods and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ItemDescription is a required property for LineForSefazGoods and cannot be null");
            }
            else
            {
            ...
            if (UseType == null)
            {
                throw new InvalidDataException("UseType is a required property for LineForSefazGoods and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("ProcessScenario is a required property for LineForSefazGoods and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as LineForSefazGoods);
        }

        /// <summary>
        /// Returns true if LineForSefazGoods instances are equal
        /// </summary>
        /// <param name="other">Instance of LineForSefazGoods to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LineForSefazGoods other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                ...
                (
                    ...
                    this.Extend != null &&
                    this.Extend.Equals(other.Extend)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Extend != null)
                    hash = hash * 59 + this.Extend.GetHashCode();
                return hash;
            }
        }
