...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PayRecLinesOut :  IEquatable<PayRecLinesOut>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PayRecLinesOut" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayRecLinesOut() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayRecLinesOut" /> class.
        /// </summary>
        ...
        /// <param name="LineAmount">GrossAmount of this installment line.</param>
        /// <param name="LineNetValue">Net value, the net Value is Gross value plus penalty minus sum of discount and withhold taxes.</param>
        /// <param name="WithholdingMode">x is because not subject of this tax independent of Threshold.</param>
        /// <param name="CalculatedTax">CalculatedTax.</param>
        public PayRecLinesOut(int? LineCode = default(int?), LineTypeEnum? LineType = default(LineTypeEnum?), string ItemCode = default(string), string ItemDescription = default(string), string ItemDocNumber = default(string), double? LineUntaxedPenality = default(double?), double? LineUntaxedDiscount = default(double?), double? LineAmount = default(double?), double? LineNetValue = default(double?), WithholdingMode WithholdingMode = default(WithholdingMode), PaymentCalculatedTax CalculatedTax = default(PaymentCalculatedTax))
        {
            // to ensure "ItemCode" is required (not null)
            if (ItemCode == null)
            {
                throw new InvalidDataException("ItemCode is a required property for PayRecLinesOut and cannot be null");
            }
            else
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PayRecLinesOut);
        }

        /// <summary>
        /// Returns true if PayRecLinesOut instances are equal
        /// </summary>
        /// <param name="other">Instance of PayRecLinesOut to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayRecLinesOut other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
