//
// DetailsCalculatedTaxItem.swift
//
...
open class DetailsCalculatedTaxItem: JSONEncodable {
    ...
    public var cstB: String?
    public var modBC: String?
    ...
    open func encodeToJSON() -> Any {
        ...
        nillableDictionary["cstB"] = self.cstB
        nillableDictionary["modBC"] = self.modBC
        nillableDictionary["cst"] = self.cst
