...
@implementation SWGPurchaseTaxByTypeDetail
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"locationType", @"jurisdictionName", @"jurisdictionType", @"taxType", @"rateType", @"scenario", @"subtotalTaxable", @"subtotalExempt", @"rate", @"tax", @"exemptionCode", @"significantLocations", @"taxRuleType"];
