...
@implementation SWGSalesHeaderOut
...
+ (BOOL)propertyIsOptional:(NSString *)propertyName {
  ...
  NSArray *optionalProperties = @[@"documentCode", @"taxCalculationDate", @"purchaseOrderNumber", @"rpsNumber", @"rpsSerie", @"discriminationIn", @"entity", @"payment", @"taxesConfig", @"defaultLocations", @"discriminationOut", @"xml", @"ediSyncState"];
