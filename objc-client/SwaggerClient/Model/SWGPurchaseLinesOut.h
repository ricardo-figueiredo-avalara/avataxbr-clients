...
@protocol SWGPurchaseLinesOut
@end

@interface SWGPurchaseLinesOut : SWGObject
...
/* This decimal captures the value of lineAmount - lineTaxedDiscount - sum of withholding. [optional]
 */
@property(nonatomic) NSNumber* lineNetValue;

@property(nonatomic) SWGPurchaseCalculatedTax* calculatedTax;
