...
@protocol SWGPurchaseHeaderOut
@end

@interface SWGPurchaseHeaderOut : SWGObject
...
@property(nonatomic) SWGPurchaseEntity* entity;

@property(nonatomic) SWGPurchaseHeaderOutPayment* payment;

@property(nonatomic) SWGPurchaseTaxesConfig* taxesConfig;

@property(nonatomic) SWGPurchaseDefaultLocations* defaultLocations;
