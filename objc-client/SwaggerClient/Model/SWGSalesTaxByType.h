...
@protocol SWGSalesTaxByType
@end

@interface SWGSalesTaxByType : SWGObject
...
@property(nonatomic) SWGTaxByTypeTax* csll;

@property(nonatomic) SWGTaxByTypeTax* issRf;

@property(nonatomic) SWGTaxByTypeTax* iss;

@property(nonatomic) SWGTaxByTypeTax* aproxtribCity;

@property(nonatomic) SWGTaxByTypeTax* aproxtribFed;

@property(nonatomic) SWGTaxByTypeTax* irpj;

@property(nonatomic) SWGTaxByTypeTax* inss;
