...
@interface SWGAGASTApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGAGASTApi

NSString* kSWGAGASTApiErrorDomain = @"SWGAGASTApiErrorDomain";
NSInteger kSWGAGASTApiMissingParamErrorCode = 234513;
...
-(NSNumber*) agastsCodeGetWithCode: (NSString*) code
    ...
    if (code == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGAGASTApiErrorDomain code:kSWGAGASTApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/agasts/{code}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGAgast*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGAgast*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) createAgastWithBody: (SWGAgast*) body
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/agasts"];
