...
@interface SWGCompanyProcessApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGCompanyProcessApi

NSString* kSWGCompanyProcessApiErrorDomain = @"SWGCompanyProcessApiErrorDomain";
NSInteger kSWGCompanyProcessApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGCompanyProcessApi *sharedAPI;
...
-(NSNumber*) companiesCompanyIdProcessCodeGetWithCompanyId: (NSString*) companyId
    ...
    if (companyId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGCompanyProcessApiErrorDomain code:kSWGCompanyProcessApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/companies/{companyId}/process/{code}"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGCustomProcessScenario*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGCustomProcessScenario*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) companiesCompanyIdProcessGetWithCompanyId: (NSString*) companyId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/companies/{companyId}/process"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGCustomProcessScenario>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGCustomProcessScenario>*)data, error);
                                }
                           }
          ];
}
