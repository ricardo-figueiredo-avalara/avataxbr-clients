...
@interface SWGCompanyItemCPOMServiceApi: NSObject <SWGApi>

extern NSString* kSWGCompanyItemCPOMServiceApiErrorDomain;
extern NSInteger kSWGCompanyItemCPOMServiceApiMissingParamErrorCode;
