#import "SWGInvoiceNFCeDANFEApi.h"
#import "SWGQueryParamCollection.h"
#import "SWGMessage.h"
#import "SWGValidationError.h"


@interface SWGInvoiceNFCeDANFEApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGInvoiceNFCeDANFEApi

NSString* kSWGInvoiceNFCeDANFEApiErrorDomain = @"SWGInvoiceNFCeDANFEApiErrorDomain";
NSInteger kSWGInvoiceNFCeDANFEApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGInvoiceNFCeDANFEApi *sharedAPI;
...
-(NSNumber*) invoicesNfceKeyGetWithAuthorization: (NSString*) authorization
    ...
    if (authorization == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGInvoiceNFCeDANFEApiErrorDomain code:kSWGInvoiceNFCeDANFEApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/invoices/nfce/{key}"];
