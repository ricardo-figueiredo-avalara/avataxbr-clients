...
@interface SWGTaxConfIBPTApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGTaxConfIBPTApi

NSString* kSWGTaxConfIBPTApiErrorDomain = @"SWGTaxConfIBPTApiErrorDomain";
NSInteger kSWGTaxConfIBPTApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGTaxConfIBPTApi *sharedAPI;
...
-(NSNumber*) createIbptConfWithTaxconfprocess: (SWGIbptConf*) taxconfprocess
    ...
    if (taxconfprocess == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGTaxConfIBPTApiErrorDomain code:kSWGTaxConfIBPTApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/taxconf/ibpt"];
...
-(NSNumber*) deleteIbptConfWithCode: (NSString*) code
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/taxconf/ibpt/{code}"];
...
-(NSNumber*) getIbptConfWithCode: (NSString*) code
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGIbptConf*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGIbptConf*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) getIbptConfListWithAccountId: (NSString*) accountId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGIbptConf>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGIbptConf>*)data, error);
                                }
                           }
          ];
}
