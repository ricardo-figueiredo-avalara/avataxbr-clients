#import "SWGServiceCalculationsApi.h"
...
@interface SWGServiceCalculationsApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGServiceCalculationsApi

NSString* kSWGServiceCalculationsApiErrorDomain = @"SWGServiceCalculationsApiErrorDomain";
NSInteger kSWGServiceCalculationsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGServiceCalculationsApi *sharedAPI;
...
-(NSNumber*) calculationsAccountAccountIdCompanyCompanyCodeTransactionTypeDocumentCodeGetWithAuthorization: (NSString*) authorization
    ...
    if (authorization == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGServiceCalculationsApiErrorDomain code:kSWGServiceCalculationsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
    ...
    if (companyCode == nil) {
        NSParameterAssert(companyCode);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"companyCode"] };
            NSError* error = [NSError errorWithDomain:kSWGServiceCalculationsApiErrorDomain code:kSWGServiceCalculationsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    ...
    if (transactionType == nil) {
        NSParameterAssert(transactionType);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"transactionType"] };
            NSError* error = [NSError errorWithDomain:kSWGServiceCalculationsApiErrorDomain code:kSWGServiceCalculationsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    ...
    if (documentCode == nil) {
        NSParameterAssert(documentCode);
        if(handler) {
            NSDictionary * userInfo = @{NSLocalizedDescriptionKey : [NSString stringWithFormat:NSLocalizedString(@"Missing required parameter '%@'", nil),@"documentCode"] };
            NSError* error = [NSError errorWithDomain:kSWGServiceCalculationsApiErrorDomain code:kSWGServiceCalculationsApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/calculations/account/{accountId}/company/{companyCode}/{transactionType}/{documentCode}"];
    ...
    if (companyCode != nil) {
        pathParams[@"companyCode"] = companyCode;
    }
    if (transactionType != nil) {
        pathParams[@"transactionType"] = transactionType;
    }
    if (documentCode != nil) {
        pathParams[@"documentCode"] = documentCode;
    }
...
-(NSNumber*) calculationsAccountAccountIdCompanyCompanyCodeTransactionTypeDocumentCodeTransactionsPostWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/calculations/account/{accountId}/company/{companyCode}/{transactionType}/{documentCode}/transactions"];
...
-(NSNumber*) calculationsAccountAccountIdCompanyCompanyCodeTransactionTypeGetWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/calculations/account/{accountId}/company/{companyCode}/{transactionType}"];
...
-(NSNumber*) calculationsservicePaymentPostWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/calculations?service-payment"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPaymentTransactionOut*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPaymentTransactionOut*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) calculationsservicePurchasePostWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/calculations?service-purchase"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGPurchaseTransactionOut*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGPurchaseTransactionOut*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) calculationsserviceReceiptPostWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/calculations?service-receipt"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGReceiptTransactionOut*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGReceiptTransactionOut*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) calculationsserviceSalesPostWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/calculations?service-sales"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGSalesTransactionOut*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGSalesTransactionOut*)data, error);
                                }
                           }
          ];
}
