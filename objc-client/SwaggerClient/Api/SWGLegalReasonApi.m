...
@interface SWGLegalReasonApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGLegalReasonApi

NSString* kSWGLegalReasonApiErrorDomain = @"SWGLegalReasonApiErrorDomain";
NSInteger kSWGLegalReasonApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGLegalReasonApi *sharedAPI;
...
-(NSNumber*) createReason_WithBody: (SWGLegalReason*) body
    ...
    if (body == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGLegalReasonApiErrorDomain code:kSWGLegalReasonApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }

    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/taxconf/legal-reason"];
...
-(NSNumber*) deleteReason_WithUuid: (NSString*) uuid
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/taxconf/legal-reason/{uuid}"];
...
-(NSNumber*) listReasonWithCompanyId: (NSString*) companyId
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGLegalReason>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGLegalReason>*)data, error);
                                }
                           }
          ];
}
