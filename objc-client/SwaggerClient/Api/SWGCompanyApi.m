...
-(NSNumber*) companiesGetWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/companies"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGCompany>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGCompany>*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) createCompanyWithBody: (SWGCompany*) body
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGCompany*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGCompany*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) deleteAccountCompanyWithAccountId: (NSString*) accountId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/accounts/{accountId}/companies/{companyId}"];
...
-(NSNumber*) deleteCompanyWithCompanyId: (NSString*) companyId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/companies/{companyId}"];
