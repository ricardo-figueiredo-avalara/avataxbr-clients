#import "SWGInvoiceSettingsApi.h"
...
@interface SWGInvoiceSettingsApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGInvoiceSettingsApi

NSString* kSWGInvoiceSettingsApiErrorDomain = @"SWGInvoiceSettingsApiErrorDomain";
NSInteger kSWGInvoiceSettingsApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGInvoiceSettingsApi *sharedAPI;
...
-(NSNumber*) invoiceSettingsWithCompletionHandler: 
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/invoices/settings"];
