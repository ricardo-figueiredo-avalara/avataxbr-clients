...
@interface SWGCompanyLocationApi: NSObject <SWGApi>

extern NSString* kSWGCompanyLocationApiErrorDomain;
extern NSInteger kSWGCompanyLocationApiMissingParamErrorCode;
