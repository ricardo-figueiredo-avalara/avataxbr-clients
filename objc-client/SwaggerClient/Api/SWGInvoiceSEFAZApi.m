...
@interface SWGInvoiceSEFAZApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGInvoiceSEFAZApi

NSString* kSWGInvoiceSEFAZApiErrorDomain = @"SWGInvoiceSEFAZApiErrorDomain";
NSInteger kSWGInvoiceSEFAZApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGInvoiceSEFAZApi *sharedAPI;
...
-(NSNumber*) invoicesSefazDeleteWithAuthorization: (NSString*) authorization
    ...
    if (authorization == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGInvoiceSEFAZApiErrorDomain code:kSWGInvoiceSEFAZApiMissingParamErrorCode userInfo:userInfo];
            handler(nil, error);
        }
        return nil;
    }
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/invoices/sefaz"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                       ...
                       responseContentType: responseContentType
                              responseType: @"SWGSefazInvoiceBasicStatus*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGSefazInvoiceBasicStatus*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) invoicesSefazKeyDeleteWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/invoices/sefaz/{key}"];
...
-(NSNumber*) invoicesSefazKeyGetWithAuthorization: (NSString*) authorization
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGSefazItGetOut*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGSefazItGetOut*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) invoicesSefazKeyLookupGetWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/invoices/sefaz/{key}/lookup"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGTransactionForSefazGoodsList*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGTransactionForSefazGoodsList*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) invoicesSefazPostWithAuthorization: (NSString*) authorization
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGSefazPostOut*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGSefazPostOut*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) invoicesSefazStatusGetWithAuthorization: (NSString*) authorization
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/invoices/sefaz/status"];
