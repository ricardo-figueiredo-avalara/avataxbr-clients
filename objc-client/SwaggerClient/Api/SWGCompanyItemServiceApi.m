#import "SWGCompanyItemServiceApi.h"
...
@interface SWGCompanyItemServiceApi ()

@property (nonatomic, strong) NSMutableDictionary *defaultHeaders;

@end

@implementation SWGCompanyItemServiceApi

NSString* kSWGCompanyItemServiceApiErrorDomain = @"SWGCompanyItemServiceApiErrorDomain";
NSInteger kSWGCompanyItemServiceApiMissingParamErrorCode = 234513;
...
+ (instancetype)sharedAPI {
    static SWGCompanyItemServiceApi *sharedAPI;
...
-(NSNumber*) companiesCompanyIdItemsCodeChangeCodePutWithCompanyId: (NSString*) companyId
    ...
    if (companyId == nil) {
        ...
        if(handler) {
            ...
            NSError* error = [NSError errorWithDomain:kSWGCompanyItemServiceApiErrorDomain code:kSWGCompanyItemServiceApiMissingParamErrorCode userInfo:userInfo];
            handler(error);
        }
        return nil;
    }
...
-(NSNumber*) companiesCompanyIdItemsCodeserviceGetWithCompanyId: (NSString*) companyId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/companies/{companyId}/items/{code}?service"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"SWGItemSimple*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((SWGItemSimple*)data, error);
                                }
                           }
          ];
}
...
-(NSNumber*) companiesCompanyIdItemsserviceGetWithCompanyId: (NSString*) companyId
    ...
    NSMutableString* resourcePath = [NSMutableString stringWithFormat:@"/companies/{companyId}/items?service"];
    ...
    return [self.apiClient requestWithPath: resourcePath
                        ...
                        requestContentType: requestContentType
                       responseContentType: responseContentType
                              responseType: @"NSArray<SWGItemSimple>*"
                           completionBlock: ^(id data, NSError *error) {
                                if(handler) {
                                    handler((NSArray<SWGItemSimple>*)data, error);
                                }
                           }
          ];
}
