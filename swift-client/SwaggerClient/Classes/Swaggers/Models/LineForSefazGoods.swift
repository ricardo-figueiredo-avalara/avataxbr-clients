...
public class LineForSefazGoods: JSONEncodable {
    public enum UseType: String { 
        ...
        case TransportOfGoodsThatDon&#39;tNeedInvoice(nf) = "transport of goods that don&#39;t need invoice (nf)"
    }
    ...
    public var extend: AgastExtendForSefaz?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["extend"] = self.extend?.encodeToJSON()
