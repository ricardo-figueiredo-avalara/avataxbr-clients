...
public class SalesHeaderOut: JSONEncodable {
    ...
    public enum EdiSyncState: String { 
        case Stored = "STORED"
        case WaitingApproval = "WAITING APPROVAL"
        case Authorized = "AUTHORIZED"
        case AuthorizedWithNote = "AUTHORIZED with NOTE"
        case Error = "ERROR"
        case CanceledReplaced = "CANCELED REPLACED"
    ...
    public var payment: SalesHeaderOutPayment?
    ...
    public var discriminationOut: String?
    ...
    public var ediSyncState: EdiSyncState?
    ...
    func encodeToJSON() -> AnyObject {
        ...
        nillableDictionary["discriminationOut"] = self.discriminationOut
        nillableDictionary["xml"] = self.xml
        nillableDictionary["ediSyncState"] = self.ediSyncState?.rawValue
